...
func ProductionRegistry() *Registry {
	...
	for _, definition := range []Definition{
		...
		},
		{
			...
			AllowedTools:  []string{"lease.portfolio.summary", "fpna.management.pre_read", "retail.store.performance.read", "retail.rent_to_sales.read", "retail.equipment.performance.read", "fpna.actions.read", "lease.close.readiness", "fpna.budget.variance.read", "fpna.cashflow.scenario", "lease.renewal.decisions", "retail.store.scenario.simulate", "retail.equipment.scenario.simulate", "lease.deal.simulate", "lease.predeal.simulate", "lease.renewal.simulate", "fpna.decision.summary", "fpna.actions.draft.create", "fpna.explanations.draft.create", "fpna.meeting_actions.draft.create", "fpna.memos.decision.draft.create", "fpna.scenarios.draft.create", "lease.contract.search", "fpna.store_pnl.read", "lease.monthly_closing.batches.read", "lease.monthly_closing.entries.preview", "lease.monthly_closing.periods.read", "lease.monthly_closing.lock_status.read", "retail.operating_facts.stores.read", "retail.operating_facts.store_days.read", "retail.kpis.store_days.read", "lease.report.schedule.read", "lease.report.disclosure_package.read", "lease.report.contract_view.read", "lease.report.unit_price.read", "lease.report.tags.read"},
