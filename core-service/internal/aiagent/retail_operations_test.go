...
func TestRetailAgentIgnoresPromptAuthorityAndRequestsMissingContext(t *testing.T) {
	...
	trafficAgent := NewWithOperationalReadersAndGovernanceAndRetail(nil, nil, nil, nil, nil, nil, nil, traffic, nil, nil)
...
func TestRetailAgentLowEvidenceContractsAreInAssistantOutput(t *testing.T) {
	...
	noFactsAgent := NewWithOperationalReadersAndGovernanceAndRetail(nil, nil, nil, nil, nil, nil, nil, noFactsReader, nil, nil)
	...
	invalidAgent := NewWithOperationalReadersAndGovernanceAndRetail(nil, nil, nil, nil, nil, nil, nil, invalidReader, nil, nil)
	filters := agentRetailScenarioFilters()
