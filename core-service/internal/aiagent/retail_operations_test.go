...
func TestRetailAgentIgnoresPromptAuthorityAndRequestsMissingContext(t *testing.T) {
	...
	trafficAgent := NewWithOperationalReadersAndGovernanceAndRetail(nil, nil, nil, nil, nil, nil, nil, traffic)
...
func TestRetailAgentLowEvidenceContractsAreInAssistantOutput(t *testing.T) {
	...
	invalidAgent := NewWithOperationalReadersAndGovernanceAndRetail(nil, nil, nil, nil, nil, nil, nil, invalidReader)
	filters := agentRetailScenarioFilters()
