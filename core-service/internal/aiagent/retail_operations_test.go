...
func TestRetailAgentIgnoresPromptAuthorityAndRequestsMissingContext(t *testing.T) {
	...
	trafficAgent := NewWithOperationalReadersAndGovernanceAndRetail(nil, nil, nil, nil, nil, nil, nil, traffic, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestRetailAgentLowEvidenceContractsAreInAssistantOutput(t *testing.T) {
	...
	noFactsAgent := NewWithOperationalReadersAndGovernanceAndRetail(nil, nil, nil, nil, nil, nil, nil, noFactsReader, nil, nil, nil, nil, nil, nil, nil, nil)
	...
	invalidAgent := NewWithOperationalReadersAndGovernanceAndRetail(nil, nil, nil, nil, nil, nil, nil, invalidReader, nil, nil, nil, nil, nil, nil, nil, nil)
	filters := agentRetailScenarioFilters()
