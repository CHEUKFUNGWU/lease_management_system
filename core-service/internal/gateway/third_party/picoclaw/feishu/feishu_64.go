...
// Upstream path: channels/feishu/feishu_64.go
...
import (
	...
	"github.com/lease-management-system/core-service/internal/gateway/third_party/picoclaw/utils"
)
...
func NewFeishuChannel(bc *config.Channel, cfg *config.FeishuSettings, bus channels.MessageBus) (*FeishuChannel, error) {
