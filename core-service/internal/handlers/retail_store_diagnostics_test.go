...
func TestRetailStoreDiagnosticsHandlerValidationAndOptions(t *testing.T) {
	...
	r.ServeHTTP(badWindow, httptest.NewRequest(http.MethodGet, "/diagnostics/00000000-0000-0000-0000-000000000001?data_classification=simulated&dataset_version=planA-v1&as_of=2026-06-14&window_days=8", nil))
