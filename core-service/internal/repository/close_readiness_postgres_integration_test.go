...
func TestCloseReadinessRepositoryAppliesPopulationAndScopeFacts(t *testing.T) {
	...
	if _, err := pool.Exec(ctx, `
		INSERT INTO lease_contracts (id, contract_number, contract_name, legal_entity_id, store_id, landlord_id, commencement_date, lease_start_date, lease_end_date, approval_status, is_official_version)
		VALUES ($1, $2, 'Other', $3, $4, $5, '2026-01-01', '2026-01-01', '2027-01-01', 'approved', true)
