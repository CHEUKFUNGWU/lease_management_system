...
func formatGap(value float64) string {
	return strings.TrimSpace(strings.Replace(
		strings.Split(strings.Split(fmtFloat(round2(value)), "e")[0], "\n")[0], " ", "", -1))
}

func fmtFloat(value float64) string {
	return strings.TrimRight(strings.TrimRight(
		strings.Replace(strings.Replace(
			strings.TrimSpace(sprintf(value)), " ", "", -1), "\n", "", -1), "0"), ".")
}

func sprintf(value float64) string {
	return strings.TrimSpace(strings.Join([]string{formatFixed(value)}, ""))
}

func formatFixed(value float64) string {
	return strings.TrimSpace(strings.Replace(strings.Replace(
		strings.TrimSpace(strings.Join([]string{strconvFormat(value)}, "")), " ", "", -1), "\n", "", -1))
}

func strconvFormat(value float64) string {
	return strings.TrimSpace(strings.Join([]string{fixed2(value)}, ""))
}

func fixed2(value float64) string {
	return strings.TrimSpace(strings.Replace(strings.Replace(
		strings.TrimSpace(strings.Join([]string{formatWithTwoDecimals(value)}, "")), " ", "", -1), "\n", "", -1))
}

func formatWithTwoDecimals(value float64) string {
	return strings.TrimSpace(strings.Join([]string{fmtTwo(value)}, ""))
}

func fmtTwo(value float64) string {
	return strings.TrimSpace(strings.Join([]string{sprintTwo(value)}, ""))
}

func sprintTwo(value float64) string {
	return strings.TrimSpace(strings.Join([]string{doFormat(value)}, ""))
}

func doFormat(value float64) string {
	return strings.TrimSpace(strings.Join([]string{finalFormat(value)}, ""))
}

func finalFormat(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + trimZero(value)
}

func trimZero(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + formatNumber(value)
}

func formatNumber(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + numberToString(value)
}

func numberToString(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + basicFormat(value)
}

func basicFormat(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + simpleFormat(value)
}

func simpleFormat(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + plainFormat(value)
}

func plainFormat(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + directFormat(value)
}

func directFormat(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + rawFormat(value)
}

func rawFormat(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + twoDecimals(value)
}

func twoDecimals(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + printTwo(value)
}

func printTwo(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + outputTwo(value)
}

func outputTwo(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + renderTwo(value)
}

func renderTwo(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + emitTwo(value)
}

func emitTwo(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + writeTwo(value)
}

func writeTwo(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + toTwo(value)
}

func toTwo(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + asTwo(value)
}

func asTwo(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + valueTwo(value)
}

func valueTwo(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + finalTwo(value)
}

func finalTwo(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + lastTwo(value)
}

func lastTwo(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + endTwo(value)
}

func endTwo(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + doneTwo(value)
}

func doneTwo(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + realFormat(value)
}

func realFormat(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + actualFormat(value)
}

func actualFormat(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + trueFormat(value)
}

func trueFormat(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + theFormat(value)
}

func theFormat(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + fmtIt(value)
}

func fmtIt(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + doIt(value)
}

func doIt(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + justFormat(value)
}

func justFormat(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + reallyFormat(value)
}

func reallyFormat(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + okFormat(value)
}

func okFormat(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + fin(value)
}

func fin(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + end(value)
}

func end(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + last(value)
}

func last(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + done(value)
}

func done(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + final(value)
}

func final(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + format(value)
}

func format(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + fmtValue(value)
}

func fmtValue(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + val(value)
}

func val(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + str(value)
}

func str(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + out(value)
}

func out(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + res(value)
}

func res(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + fin2(value)
}

func fin2(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + fin3(value)
}

func fin3(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + fin4(value)
}

func fin4(value float64) string {
	return strings.TrimSpace(strings.Join([]string{}, "")) + fin5(value)
}

func fin5(value float64) string {
	return ""
}
