...
function getBreadcrumbMap(language: string): Record<string, string> {
  return {
    ...
    "site-pulse": t("nav.site_pulse", language as any),
    "site-360": t("nav.site_360", language as any),
    "site-pnl": t("nav.site_pnl", language as any),
    "settlement-workbench": t("nav.settlement_workbench", language as any),
      ...
      if (canViewAnalysis) {
        ...
        groups.push({
          ...
          children: [
            ...
            item("/site-pulse", "/site-pulse", <LineChartOutlined />, t("nav.site_pulse", language as any)),
            item("/site-360", "/site-360", <LineChartOutlined />, t("nav.site_360", language as any)),
            item("/site-pnl", "/site-pnl", <FileTextOutlined />, t("nav.site_pnl", language as any)),
            item("/settlement-workbench", "/settlement-workbench", <AuditOutlined />, t("nav.settlement_workbench", language as any)),
            item("/financial-model", "/financial-model", <FileTextOutlined />, t("nav.financial_model", language as any)),
