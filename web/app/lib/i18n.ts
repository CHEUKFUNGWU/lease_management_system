...
const dict: TranslationDict = {
  ...
  "finmodel.assumptions": { "zh-CN": "假设面板（唯一硬输入区）", "zh-HK": "假設面板（唯一硬輸入區）", en: "Assumptions (the single hard-input area)" },
  "finmodel.definition_id": { "zh-CN": "模型定义 ID（/financial-model/definitions 创建）", "zh-HK": "模型定義 ID（/financial-model/definitions 創建）", en: "Model definition ID" },
  "finmodel.assumptions_hint": { "zh-CN": "JSON 对象；键为假设 key。所有假设落 fpna_assumption_versions，AI 建议只能是 draft。", "zh-HK": "JSON 對象；鍵為假設 key。所有假設落 fpna_assumption_versions，AI 建議只能是 draft。", en: "JSON object keyed by assumption key; AI suggestions stay drafts." },
  ...
  "finmodel.opening_gate": { "zh-CN": "期初 BS 三道闸（自平衡 / 归并一致 / 租赁余额对引擎勾稽）", "zh-HK": "期初 BS 三道閘（自平衡 / 歸並一致 / 租賃餘額對引擎勾稽）", en: "Opening BS gates (self-balance / merge stability / lease vs engine)" },
  ...
  "finmodel.opening_periods": { "zh-CN": "期间余额（高级：JSON 数组 [{period, lines, mapping}]）", "zh-HK": "期間餘額（高級：JSON 數組 [{period, lines, mapping}]）", en: "Period balances (advanced JSON array of {period, lines, mapping})" },
  ...
  "finmodel.opening_bad_periods": { "zh-CN": "期间余额 JSON 不合法：应为对象数组", "zh-HK": "期間餘額 JSON 不合法：應為對象數組", en: "Invalid period-balances JSON: expected an array of objects" },
