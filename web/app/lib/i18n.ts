...
const dict: TranslationDict = {
  ...
  "perf.meta": { "zh-CN": "{period} · 工作试算底稿事实 · 数据截至 {stamp} · 不替代正式台账关账。", "zh-HK": "{period} · 工作試算底稿事實 · 數據截至 {stamp} · 不替代正式台賬關賬。", en: "{period} · Working operating facts · as of {stamp} · does not replace the Official close." },
  ...
  "perf.kpi.store_facts": { "zh-CN": "门店经营事实", "zh-HK": "門店經營事實", en: "Store facts" },
  "perf.kpi.reconciled_suffix": { "zh-CN": "已对账", "zh-HK": "已對賬", en: "reconciled" },
  "perf.kpi.equipment_facts": { "zh-CN": "商圈对标事实", "zh-HK": "商圈對標事實", en: "Benchmark facts" },
