...
const dict: TranslationDict = {
  ...
  "cashflow.store.contract_committed": { "zh-CN": "已签约承诺", "zh-HK": "已簽約承諾", en: "Committed Leases" },
  "cashflow.store.est_variable": { "zh-CN": "假设续租", "zh-HK": "假設續租", en: "Assumed Renewal" },
  "cashflow.store.non_lease_expense": { "zh-CN": "假设关店成本", "zh-HK": "假設關店成本", en: "Assumed Closure Cost" },
