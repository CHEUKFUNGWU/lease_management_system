...
const dict: TranslationDict = {
  ...
  "tb_import.hint": { "zh-CN": "受控模板列：account_code, account_name（可选）, debit, credit；同一（来源, 期间, 内容哈希）重复导入幂等重放；功能货币为对账基础", "zh-HK": "受控模板列：account_code, account_name（可選）, debit, credit；同一（來源, 期間, 內容哈希）重複導入冪等重放；功能貨幣為對賬基礎", en: "Template columns: account_code, account_name (optional), debit, credit; re-importing the same extract replays the same version (content hash); functional currency is the reconciliation basis" },
  ...
  "perf.meta": { "zh-CN": "{period} · Working 经营事实 · 数据截至 {stamp} · 不替代 Official 关账。", "zh-HK": "{period} · Working 經營事實 · 數據截至 {stamp} · 不替代 Official 關賬。", en: "{period} · Working operating facts · as of {stamp} · does not replace the Official close." },
  ...
  "perf.kpi.store_facts": { "zh-CN": "门店事实", "zh-HK": "門店事實", en: "Store facts" },
  "perf.kpi.reconciled_suffix": { "zh-CN": "已对账", "zh-HK": "已對賬", en: "reconciled" },
  "perf.kpi.equipment_facts": { "zh-CN": "设备事实", "zh-HK": "設備事實", en: "Equipment facts" },
  "perf.kpi.open_actions": { "zh-CN": "待处理行动", "zh-HK": "待處理行動", en: "Open actions" },
  "perf.kpi.open_impact": { "zh-CN": "未兑现影响", "zh-HK": "未兌現影響", en: "Unrealised impact" },
  ...
  "perf.gov.equipment_unreconciled": { "zh-CN": "设备未对账", "zh-HK": "設備未對賬", en: "Equipment unreconciled" },
  ...
  "perf.col.revenue": { "zh-CN": "营收", "zh-HK": "營收", en: "Revenue" },
  "perf.col.four_wall_ebitda": { "zh-CN": "四墙 EBITDA", "zh-HK": "四牆 EBITDA", en: "Four-wall EBITDA" },
  ...
  "perf.col.equipment": { "zh-CN": "设备", "zh-HK": "設備", en: "Equipment" },
  "perf.col.utilization": { "zh-CN": "利用率", "zh-HK": "利用率", en: "Utilisation" },
  "perf.col.cost_variance": { "zh-CN": "成本差异", "zh-HK": "成本差異", en: "Cost variance" },
  "perf.col.residual": { "zh-CN": "残差", "zh-HK": "殘差", en: "Residual" },
  "perf.status.bridge_balanced": { "zh-CN": "桥接平衡", "zh-HK": "橋接平衡", en: "Bridge ties out" },
  "perf.status.insufficient_evidence": { "zh-CN": "证据不足", "zh-HK": "證據不足", en: "Insufficient evidence" },
  "perf.col.action": { "zh-CN": "异常 / 行动", "zh-HK": "異常 / 行動", en: "Exception / action" },
  "perf.col.impact": { "zh-CN": "影响", "zh-HK": "影響", en: "Impact" },
  "perf.col.severity": { "zh-CN": "优先级", "zh-HK": "優先級", en: "Priority" },
  "perf.col.status": { "zh-CN": "状态", "zh-HK": "狀態", en: "Status" },
  "perf.col.owner_due": { "zh-CN": "负责人 / 到期", "zh-HK": "負責人 / 到期", en: "Owner / due" },
  "perf.unassigned": { "zh-CN": "未分配", "zh-HK": "未分配", en: "Unassigned" },
  "perf.no_date": { "zh-CN": "无日期", "zh-HK": "無日期", en: "No date" },
  "perf.col.operation": { "zh-CN": "操作", "zh-HK": "操作", en: "Action" },
  "perf.acknowledge": { "zh-CN": "确认", "zh-HK": "確認", en: "Acknowledge" },
  ...
  "perf.tab.actions": { "zh-CN": "行动中心", "zh-HK": "行動中心", en: "Actions" },
  "perf.tab.stores": { "zh-CN": "零售四墙", "zh-HK": "零售四牆", en: "Four-wall" },
  "perf.tab.equipment": { "zh-CN": "制造设备", "zh-HK": "製造設備", en: "Equipment" },
  "perf.tab.scenario": { "zh-CN": "门店方案模拟", "zh-HK": "門店方案模擬", en: "Store scenario" },
  "perf.bulk_acknowledge": { "zh-CN": "批量确认", "zh-HK": "批量確認", en: "Acknowledge selected" },
  "perf.export_working_csv": { "zh-CN": "导出 Working CSV", "zh-HK": "匯出 Working CSV", en: "Export Working CSV" },
  "perf.empty.actions": { "zh-CN": "当前期间没有待处理行动", "zh-HK": "當前期間沒有待處理行動", en: "No open actions this period" },
  "perf.empty.stores": { "zh-CN": "暂无门店经营事实；请先导入受控事实批次", "zh-HK": "暫無門店經營事實；請先導入受控事實批次", en: "No store facts yet — import a controlled batch first" },
  "perf.empty.equipment": { "zh-CN": "暂无设备经营事实；请先导入受控事实批次", "zh-HK": "暫無設備經營事實；請先導入受控事實批次", en: "No equipment facts yet — import a controlled batch first" },
  "perf.scenario.draft_title": { "zh-CN": "Scenario 草稿", "zh-HK": "Scenario 草稿", en: "Scenario draft" },
  "perf.scenario.draft_note": { "zh-CN": "下面的假设只进入确定性模拟，不会覆盖 Budget/Forecast、创建正式合同或触发会计重算；正式决策仍需人工确认。", "zh-HK": "下面的假設只進入確定性模擬，不會覆蓋 Budget/Forecast、創建正式合同或觸發會計重算；正式決策仍需人工確認。", en: "These assumptions feed a deterministic simulation only. They never overwrite budget or forecast, create a contract, or trigger an accounting rerun — a real decision still needs a person." },
  ...
  "perf.scenario.run": { "zh-CN": "运行确定性模拟", "zh-HK": "運行確定性模擬", en: "Run simulation" },
  "perf.scenario.col_name": { "zh-CN": "方案", "zh-HK": "方案", en: "Option" },
  "perf.scenario.col_payback": { "zh-CN": "回收期（月）", "zh-HK": "回收期（月）", en: "Payback (months)" },
  "perf.scenario.col_breakeven": { "zh-CN": "盈亏平衡月租", "zh-HK": "盈虧平衡月租", en: "Break-even rent" },
  "perf.scenario.col_negotiation": { "zh-CN": "议价范围", "zh-HK": "議價範圍", en: "Negotiation range" },
  "perf.scenario.empty": { "zh-CN": "输入关键假设后运行模拟", "zh-HK": "輸入關鍵假設後運行模擬", en: "Enter the assumptions, then run the simulation" },
  "perf.import_monthly": { "zh-CN": "导入月度事实（CSV/XLSX）", "zh-HK": "導入月度事實（CSV/XLSX）", en: "Import monthly facts (CSV/XLSX)" },
  "perf.import_source": { "zh-CN": "来源系统", "zh-HK": "來源系統", en: "Source system" },
  ...
  "perf.import_replay": { "zh-CN": "幂等重放", "zh-HK": "冪等重放", en: "idempotent replay" },
  "tb_import.replay": { "zh-CN": "同一内容身份已存在，幂等重放", "zh-HK": "同一內容身份已存在，冪等重放", en: "Same content identity exists — idempotent replay" },
  "plan_import.replay": { "zh-CN": "同一（名称, 快照期间）版本已存在，幂等重放", "zh-HK": "同一（名稱, 快照期間）版本已存在，冪等重放", en: "An identical (name, as-of period) version exists — idempotent replay" },
