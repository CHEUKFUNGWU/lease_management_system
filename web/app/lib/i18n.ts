...
const dict: TranslationDict = {
  ...
  "storepnl.formula_hint": { "zh-CN": "公式（白名单 DSL，如 rows.revenue - rows.labor_cost；后端保存时校验）", "zh-HK": "公式（白名單 DSL；後端保存時校驗）", en: "Formula (whitelist DSL, e.g. rows.revenue - rows.labor_cost; validated on save)" },
