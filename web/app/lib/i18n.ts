...
/** 只读导出供测试断言键存在（gap-kinds.test.ts 等）；运行时文案一律走 t()。 */
export const dict: TranslationDict = {
  ...
  "chart.confidence.empty": {
    "zh-CN": "暂无走势数据",
    "zh-HK": "暫無走勢數據",
    en: "No trend data",
  },
  "chart.confidence.peer_median": {
    "zh-CN": "同群中位数",
    "zh-HK": "同群中位數",
    en: "Peer median",
  },
  "chart.confidence.band": {
    "zh-CN": "同群置信安全带 (P25~P75)",
    "zh-HK": "同群置信安全帶 (P25~P75)",
    en: "Peer confidence band (P25–P75)",
  },
  "chart.confidence.baseline_median": {
    "zh-CN": "基准中位数",
    "zh-HK": "基準中位數",
    en: "Baseline median",
  },
  "chart.waterfall.empty": {
    "zh-CN": "暂无瀑布图数据",
    "zh-HK": "暫無瀑布圖數據",
    en: "No waterfall data",
  },
  "chart.waterfall.total": {
    "zh-CN": "结算总额",
    "zh-HK": "結算總額",
    en: "Settlement total",
  },
  "chart.waterfall.change": {
    "zh-CN": "变动金额",
    "zh-HK": "變動金額",
    en: "Change",
  },
  "chart.waterfall.running_total": {
    "zh-CN": "累计净额",
    "zh-HK": "累計淨額",
    en: "Running total",
  },
  ...
  // F2-1：三表财务模型 / 单店利润表 / 月结中心帮助（术语最密的三个页面）
  "help.finmodel.title": { "zh-CN": "三表财务模型使用指南", "zh-HK": "三表財務模型使用指南", en: "Financial model guide" },
  "help.finmodel.s1.heading": { "zh-CN": "期初三道闸各拦什么", "zh-HK": "期初三道閘各攔什麼", en: "What each opening gate blocks" },
  "help.finmodel.s1.body": { "zh-CN": "闸① 拦不平衡的期初表：每个期间资产必须等于负债加权益。闸② 拦归并漂移：同一外部科目在所有期间必须映射到同一标准行。闸③ 拦两套账对不上：导入口径与计量引擎的逐合约租赁余额必须完全一致——引擎是唯一权威。任何一道不过，校验都会明确告诉你哪一期间哪一行出了问题。", "zh-HK": "閘① 攔不平衡的期初表：每個期間資產必須等於負債加權益。閘② 攔歸並漂移：同一外部科目在所有期間必須映射到同一標準行。閘③ 攔兩套賬對不上：導入口徑與計量引擎的逐合約租賃餘額必須完全一致——引擎是唯一權威。任何一道不過，校驗都會明確告訴你哪一期間哪一行出了問題。", en: "Gate 1 blocks unbalanced openings: assets must equal liabilities plus equity for every period. Gate 2 blocks mapping drift: each external account maps to one standard line across all periods. Gate 3 blocks mismatched lease balances: imported per-contract balances must equal the measurement engine exactly. The engine is the single authority. Any failure names the period and row." },
  "help.finmodel.s2.heading": { "zh-CN": "勾稽不过时下一步做什么", "zh-HK": "勾稽不過時下一步做什麼", en: "What to do when tie-outs fail" },
  "help.finmodel.s2.body": { "zh-CN": "勾稽表逐行列出期望值、实际值与差额。差额非零时，先看缺口清单：经营事实缺失或覆盖不足，去导入中心补数；假设未登记，回第②步补齐假设；端口未接线属系统配置问题，请联系管理员。修正后重新运行测算即可；缺口不清零，发布按钮会保持禁用。", "zh-HK": "勾稽表逐行列出期望值、實際值與差額。差額非零時，先看缺口清單：經營事實缺失或覆蓋不足，去導入中心補數；假設未登記，回第②步補齊假設；端口未接線屬系統配置問題，請聯絡管理員。修正後重新執行測算即可；缺口不清零，發佈按鈕會保持禁用。", en: "The tie-out table lists expected, actual and diff per check. For non-zero diffs read the gap list first: missing facts or coverage go to the import center; unregistered assumptions go back to step ②; unwired ports are a configuration issue for your admin. Re-run after fixing. Publish stays disabled until every gap clears." },
  "help.finmodel.s3.heading": { "zh-CN": "发布的计划版本谁能看到", "zh-HK": "發佈的計劃版本誰能看到", en: "Who sees a published plan version" },
  "help.finmodel.s3.body": { "zh-CN": "发布会在你的法人范围内生成一个计划版本，进入计划对比与 FP&A 工作台供授权同事查看，并记录来源测算与情景类型；模拟数据的测算不能发布。未发布的测算只有你能看到。", "zh-HK": "發佈會在你的法人範圍內生成一個計劃版本，進入計劃對比與 FP&A 工作台供授權同事查看，並記錄來源測算與情景類型；模擬數據的測算不能發佈。未發佈的測算只有你能看到。", en: "Publishing creates one plan version inside your legal entity: it becomes visible to authorized colleagues through plan comparison and the FP&A workbench, with its source run and scenario type recorded. Simulated-data runs cannot be published. Unpublished runs stay private to you." },
  "help.storepnl.title": { "zh-CN": "单店利润表使用指南", "zh-HK": "單店利潤表使用指南", en: "Store P&L guide" },
  "help.storepnl.flow.pick_store": { "zh-CN": "选择门店与截止日", "zh-HK": "選擇門店與截止日", en: "Pick store & as-of date" },
  "help.storepnl.flow.pick_compare": { "zh-CN": "选择对比列（预算/预测/去年同期）", "zh-HK": "選擇對比列（預算/預測/去年同期）", en: "Pick comparison column" },
  "help.storepnl.flow.read_bases": { "zh-CN": "双口径并列读数", "zh-HK": "雙口徑並列讀數", en: "Read both bases side by side" },
  "help.storepnl.flow.drill": { "zh-CN": "构成下钻与来源追溯", "zh-HK": "構成下鑽與來源追溯", en: "Drill components & provenance" },
  "help.storepnl.s1.heading": { "zh-CN": "经营口径与 IFRS 16 口径为什么不一样", "zh-HK": "經營口徑與 IFRS 16 口徑為什麼不一樣", en: "Why operating and IFRS 16 bases differ" },
  "help.storepnl.s1.body": { "zh-CN": "两个口径回答不同的问题。经营口径算「这家店这个月花了多少现金占用成本」（基本租金＋服务费＋当期变量租金）；IFRS 16 口径算会计费用（使用权资产折旧＋租赁负债利息）。同一笔租金在两边以不同名字出现，所以两个区块并列展示、永不合计，也不该相加。", "zh-HK": "兩個口徑回答不同的問題。經營口徑算「這家店這個月花了多少現金佔用成本」（基本租金＋服務費＋當期變量租金）；IFRS 16 口徑算會計費用（使用權資產折舊＋租賃負債利息）。同一筆租金在兩邊以不同名字出現，所以兩個區塊並列展示、永不合計，也不該相加。", en: "The two bases answer different questions. The operating basis shows the cash cost of holding the store this month (base rent + service charge + variable rent incurred); the IFRS 16 basis shows accounting expense (ROU depreciation + lease interest). The same rent appears under different names on each side, so the blocks are presented side by side and never summed." },
  "help.storepnl.s2.heading": { "zh-CN": "Decision Ready 不满足时这张表还能不能用", "zh-HK": "Decision Ready 不滿足時這張表還能不能用", en: "Can I still use this P&L when it is not decision-ready" },
  "help.storepnl.s2.body": { "zh-CN": "能看，但不能直接拿去拍板。未就绪说明事实覆盖或币种基础不足以支撑结论，页面会给出原因；此时数字仍然反映已发生的事实，可用于了解大致情况，但不要据此做同业对比或考核结论。缺数行显示为「—」而非 0——那代表没有数据，不是零成本。", "zh-HK": "能看，但不能直接拿去拍板。未就緒說明事實覆蓋或幣種基礎不足以支持結論，頁面會給出原因；此時數字仍反映已發生的事實，可用於了解大致情況，但不要據此做同業對比或考核結論。缺數行顯示為「—」而非 0——那代表沒有數據，不是零成本。", en: "You can view it, but do not decide on it. Not-ready means fact coverage or currency basis cannot support a conclusion; the page states why. The figures still reflect observed facts and are fine for orientation, but avoid peer comparisons or performance conclusions until ready. Missing lines show 「—」, never 0. That is no data, not zero cost." },
  "help.storepnl.s3.heading": { "zh-CN": "每个数字从哪里来", "zh-HK": "每個數字從哪裡來", en: "Where each number comes from" },
  "help.storepnl.s3.body": { "zh-CN": "来源列可悬停查看每个科目的数据来源系统、导入批次、事实版本区间与截止时间。这是审计与复盘的基础：任何一行都能回答「这个数是谁、在哪天、从哪个系统来的」。", "zh-HK": "來源列可懸停查看每個科目的數據來源系統、導入批次、事實版本區間與截止時間。這是審計與復盤的基礎：任何一行都能回答「這個數是誰、在哪一天、從哪個系統來的」。", en: "Hover the provenance column to see each line's source systems, import batches, fact-version range and as-of time. That is the audit trail: every line answers who loaded what from which system, and when." },
  "help.monthly.title": { "zh-CN": "月结中心使用指南", "zh-HK": "月結中心使用指南", en: "Monthly closing guide" },
  "help.monthly.flow.period": { "zh-CN": "选期间与范围", "zh-HK": "選期間與範圍", en: "Pick period & scope" },
  "help.monthly.flow.entries": { "zh-CN": "生成分录并复核", "zh-HK": "生成分錄並復核", en: "Generate & review entries" },
  "help.monthly.flow.review": { "zh-CN": "审批确认", "zh-HK": "審批確認", en: "Approve" },
  "help.monthly.flow.post_lock": { "zh-CN": "过账回写并锁账", "zh-HK": "過賬回寫並鎖賬", en: "Post to GL & lock" },
  "help.monthly.s1.heading": { "zh-CN": "本页动作与总账的关系", "zh-HK": "本頁動作與總賬的關係", en: "How this page relates to the general ledger" },
  "help.monthly.s1.body": { "zh-CN": "流程为：就绪检查 → 生成分录 → 复核 → 审批 → 过账 → 锁定期间。审批前的分录只是预览；过账才把分录写入总账并回传凭证号；锁定期间表示本期不再接受改动。每一步的状态都留在页面上，可按法人、区域、品牌批量执行。", "zh-HK": "流程為：就緒檢查 → 生成分錄 → 覆核 → 審批 → 過賬 → 鎖定期間。審批前的分錄只是預覽；過賬才把分錄寫入總賬並回傳憑證號；鎖定期間表示本期不再接受改動。每一步的狀態都留在頁面上，可按法人、區域、品牌批量執行。", en: "Flow: readiness → generate entries → review → approve → post → lock. Entries before approval are previews only; posting writes them into the GL and records voucher numbers; locking closes the period against further changes. Each step's status stays on the page, with batch runs by entity, region or brand." },
  "help.monthly.s2.heading": { "zh-CN": "哪些动作不可逆", "zh-HK": "哪些動作不可逆", en: "Which actions are irreversible" },
  "help.monthly.s2.body": { "zh-CN": "过账与锁定期间不可在本页撤销：过账后的分录要靠总账冲销/重过账流程处理；已锁定的期间不能覆盖，需要重开期间流程并留痕。生成分录、复核、驳回草稿都可反复进行，不会影响总账。", "zh-HK": "過賬與鎖定期間不可在本頁撤銷：過賬後的分錄要靠總賬沖銷/重過賬流程處理；已鎖定的期間不能覆蓋，需要重開期間流程並留痕。生成分錄、覆核、駁回草稿都可反復進行，不會影響總賬。", en: "Posting and locking cannot be undone here: posted entries require the GL reversal / re-posting flow; a locked period can never be overwritten and needs the period-reopen process with full audit trail. Generating, reviewing and rejecting drafts are freely repeatable and never touch the GL." },
  "help.monthly.s3.heading": { "zh-CN": "就绪检查在看什么", "zh-HK": "就緒檢查在看什麼", en: "What the readiness check looks at" },
  "help.monthly.s3.body": { "zh-CN": "就绪检查核对的是「该评估的对象是否都评估了」：合同清单是否完整、异常事项是否有处置结论。它不是健康度评分——有例外不代表流程坏了，但阻塞类例外未处置完，期间就无法进入下一步。", "zh-HK": "就緒檢查核對的是「該評估的對象是否都評估了」：合同清單是否完整、異常事項是否有處置結論。它不是健康度評分——有例外不代表流程壞了，但阻塞類例外未處置完，期間就無法進入下一步。", en: "Readiness checks whether everything in scope was actually evaluated: contract population complete, every exception dispositioned. It is not a health score. Exceptions do not mean the process broke, but blocking ones must close before the period advances." },
  "common.ai_analysis": {
    "zh-CN": "交给 AI 分析",
    "zh-HK": "交給 AI 分析",
    en: "Analyze with AI",
  },
  "common.optional": { "zh-CN": "可选", "zh-HK": "可選", en: "optional" },
  ...
  // ── 电商独立站模式（ecommerce-dtc-mode-v1）──
  "nav.site_pulse": { "zh-CN": "站点脉搏", "zh-HK": "站點脈搏", en: "Site Pulse" },
  "nav.site_360": { "zh-CN": "站点 360", "zh-HK": "站點 360", en: "Site 360" },
  "nav.site_pnl": { "zh-CN": "单站利润表", "zh-HK": "單站利潤表", en: "Site P&L" },
  "nav.settlement_workbench": { "zh-CN": "收款对账", "zh-HK": "收款對賬", en: "Settlement" },
  "ecom.nav.operating_group_label": { "zh-CN": "电商独立站", "zh-HK": "電商獨立站", en: "E-commerce DTC" },
  "ecom.pulse.title": { "zh-CN": "站点脉搏", "zh-HK": "站點脈搏", en: "Site Pulse" },
  "ecom.pulse.subtitle": { "zh-CN": "三站一页：净收入 / CM1 率 / MER vs 前窗与预算方向；top 差异因子当天可见。", "zh-HK": "三站一頁：淨收入 / CM1 率 / MER 對比前窗與預算方向；top 差異因子當天可見。", en: "Net revenue, CM1% and MER vs previous window with top difference factors." },
  "ecom.pulse.vs_previous": { "zh-CN": "较前窗", "zh-HK": "較前窗", en: "vs previous" },
  "ecom.pulse.top_diff_factors": { "zh-CN": "前 3 差异因子", "zh-HK": "前 3 差異因子", en: "Top 3 difference factors" },
  "ecom.pulse.restated": { "zh-CN": "含重述期间", "zh-HK": "含重述期間", en: "Restated periods" },
  "ecom.common.classification": { "zh-CN": "数据分类", "zh-HK": "數據分類", en: "Data class" },
  "ecom.common.dataset_version": { "zh-CN": "模拟数据集", "zh-HK": "模擬數據集", en: "Dataset" },
  "ecom.common.as_of": { "zh-CN": "截至日期", "zh-HK": "截至日期", en: "As of" },
  "ecom.common.window_days": { "zh-CN": "窗口天数", "zh-HK": "窗口天數", en: "Window days" },
  "ecom.common.site": { "zh-CN": "站点", "zh-HK": "站點", en: "Storefront" },
  "ecom.common.code": { "zh-CN": "编码", "zh-HK": "編碼", en: "Code" },
  "ecom.common.market": { "zh-CN": "市场", "zh-HK": "市場", en: "Market" },
  "ecom.common.currency": { "zh-CN": "币种", "zh-HK": "幣種", en: "Currency" },
  "ecom.common.unavailable": { "zh-CN": "不可用", "zh-HK": "不可用", en: "Unavailable" },
  "ecom.common.no_data_reason": { "zh-CN": "该站点没有所选分类的数据：覆盖不足时结论显式降级，不补 0、不反推。", "zh-HK": "該站點沒有所選分類的數據：覆蓋不足時結論顯式降級，不補 0、不反推。", en: "No facts for this classification in the window. Degraded explicitly, never zero-filled." },
  "ecom.diagnostics.title": { "zh-CN": "站点 360", "zh-HK": "站點 360", en: "Storefront 360" },
  "ecom.diagnostics.subtitle": { "zh-CN": "单位经济与渠道结构：CAC 双口径、保本 MER/ROAS、KPI 全集。", "zh-HK": "單位經濟與渠道結構：CAC 雙口徑、保本 MER/ROAS、KPI 全集。", en: "Unit economics: dual-basis CAC, break-even MER/ROAS, full KPI set." },
  "ecom.diagnostics.cac_paid": { "zh-CN": "付费新客 CAC", "zh-HK": "付費新客 CAC", en: "Paid-new CAC" },
  "ecom.diagnostics.cac_blended": { "zh-CN": "混合 CAC", "zh-HK": "混合 CAC", en: "Blended CAC" },
  "ecom.diagnostics.break_even": { "zh-CN": "盈亏平衡", "zh-HK": "盈虧平衡", en: "Break-even" },
  "ecom.diagnostics.break_even_mer": { "zh-CN": "保本 MER", "zh-HK": "保本 MER", en: "Break-even MER" },
  "ecom.diagnostics.break_even_roas": { "zh-CN": "保本 ROAS", "zh-HK": "保本 ROAS", en: "Break-even ROAS" },
  "ecom.diagnostics.unachievable": { "zh-CN": "不可达成（CM1 率 ≤ 0）", "zh-HK": "不可達成（CM1 率 ≤ 0）", en: "Unachievable (CM1 rate ≤ 0)" },
  "ecom.pnl.title": { "zh-CN": "单站利润表", "zh-HK": "單站利潤表", en: "Storefront P&L" },
  "ecom.pnl.subtitle": { "zh-CN": "固定行序 GMV → CM2 → 经营利润；会计口径收入块只读来自总账导入，永不互换。", "zh-HK": "固定行序 GMV → CM2 → 經營利潤；會計口徑收入塊只讀來自總賬導入，永不互換。", en: "Fixed row order GMV → CM2 → operating profit; accounting revenue read-only from GL." },
  "ecom.pnl.breakdown": { "zh-CN": "下钻维度", "zh-HK": "下鑽維度", en: "Breakdown" },
  "ecom.pnl.breakdown_none": { "zh-CN": "无", "zh-HK": "無", en: "None" },
  "ecom.pnl.breakdown_channel": { "zh-CN": "渠道", "zh-HK": "渠道", en: "Channel" },
  "ecom.pnl.breakdown_campaign": { "zh-CN": "Campaign", "zh-HK": "Campaign", en: "Campaign" },
  "ecom.pnl.breakdown_sku": { "zh-CN": "SKU", "zh-HK": "SKU", en: "SKU" },
  "ecom.pnl.accounting_block": { "zh-CN": "会计口径收入（只读 GL）", "zh-HK": "會計口徑收入（只讀 GL）", en: "Accounting revenue (GL read-only)" },
  "ecom.pnl.operating_block": { "zh-CN": "经营口径", "zh-HK": "經營口徑", en: "Operating basis" },
  "ecom.settlement.title": { "zh-CN": "收款对账工作台", "zh-HK": "收款對賬工作台", en: "Settlement Workbench" },
  "ecom.settlement.subtitle": { "zh-CN": "payout × 订单应收 × 银行到账三方对账；未对平期间不得进入 Approved 口径。", "zh-HK": "payout × 訂單應收 × 銀行到賬三方對賬；未對平期間不得進入 Approved 口徑。", en: "Three-way reconciliation; unreconciled periods never enter Approved basis." },
  "ecom.settlement.create_run": { "zh-CN": "新建对账", "zh-HK": "新建對賬", en: "Run reconciliation" },
  "ecom.settlement.gate_allow": { "zh-CN": "对账通过", "zh-HK": "對賬通過", en: "Reconciliation passed" },
  "ecom.settlement.gate_deny": { "zh-CN": "对账未通过", "zh-HK": "對賬未通過", en: "Reconciliation not passed" },
  "ecom.settlement.category_fee": { "zh-CN": "手续费", "zh-HK": "手續費", en: "Fee" },
  "ecom.settlement.category_fx": { "zh-CN": "汇兑", "zh-HK": "匯兌", en: "FX" },
  "ecom.settlement.category_chargeback": { "zh-CN": "拒付", "zh-HK": "拒付", en: "Chargeback" },
  "ecom.settlement.category_in_transit": { "zh-CN": "在途", "zh-HK": "在途", en: "In transit" },
  "ecom.settlement.category_adjustment": { "zh-CN": "调整", "zh-HK": "調整", en: "Adjustment" },
  "ecom.settlement.category_reserve": { "zh-CN": "准备金", "zh-HK": "準備金", en: "Reserve" },
  "ecom.settlement.differences": { "zh-CN": "差异清单", "zh-HK": "差異清單", en: "Differences" },
  "ecom.settlement.reserve": { "zh-CN": "滚动准备金", "zh-HK": "滾動準備金", en: "Rolling reserve" },
  "ecom.settlement.action_prepare": { "zh-CN": "发起复核", "zh-HK": "發起覆核", en: "Start review" },
  "ecom.settlement.action_submit": { "zh-CN": "提交待批", "zh-HK": "提交待批", en: "Submit" },
  "ecom.settlement.action_approve": { "zh-CN": "签认", "zh-HK": "簽認", en: "Approve" },
  "ecom.settlement.action_reject": { "zh-CN": "驳回", "zh-HK": "駁回", en: "Reject" },
  "ecom.settlement.period_label": { "zh-CN": "期间", "zh-HK": "期間", en: "Period" },
  "ecom.settlement.matched": { "zh-CN": "匹配", "zh-HK": "匹配", en: "Matched" },
  "ecom.settlement.difference": { "zh-CN": "差异", "zh-HK": "差異", en: "Diffs" },
  "ecom.settlement.diff_amount": { "zh-CN": "差异金额", "zh-HK": "差異金額", en: "Diff amount" },
  "ecom.settlement.actions": { "zh-CN": "签认动作", "zh-HK": "簽認動作", en: "Actions" },
  "ecom.settlement.recon_done": { "zh-CN": "对账完成", "zh-HK": "對賬完成", en: "Recon done" },
  "ecom.settlement.status_changed": { "zh-CN": "状态已更新：", "zh-HK": "狀態已更新：", en: "Status updated: " },
  "ecom.settlement.gate": { "zh-CN": "门禁", "zh-HK": "門禁", en: "Gate" },
  "ecom.settlement.currency": { "zh-CN": "币种", "zh-HK": "幣種", en: "Currency" },
  "ecom.settlement.held_open": { "zh-CN": "占用中", "zh-HK": "佔用中", en: "Held open" },
  "ecom.settlement.released": { "zh-CN": "已释放", "zh-HK": "已釋放", en: "Released" },
  "ecom.settlement.net_frozen": { "zh-CN": "净冻结", "zh-HK": "淨凍結", en: "Net frozen" },
  "ecom.settlement.issues": { "zh-CN": "异常", "zh-HK": "異常", en: "Issues" },
  "ecom.settlement.category_label": { "zh-CN": "类别", "zh-HK": "類別", en: "Category" },
  "ecom.settlement.amount_label": { "zh-CN": "金额", "zh-HK": "金額", en: "Amount" },
  "ecom.settlement.bank_label": { "zh-CN": "银行", "zh-HK": "銀行", en: "Bank" },
  "ecom.settlement.note_label": { "zh-CN": "说明", "zh-HK": "說明", en: "Note" },
  "ecom.settlement.source_system": { "zh-CN": "来源", "zh-HK": "來源", en: "Source" },
  "ecom.settlement.import_version": { "zh-CN": "版本", "zh-HK": "版本", en: "Version" },
  "ecom.settlement.import_grain": { "zh-CN": "粒度", "zh-HK": "粒度", en: "Grain" },
  "ecom.settlement.import_columns": { "zh-CN": "列", "zh-HK": "列", en: "Columns" },
  "ecom.diagnostics.kpi": { "zh-CN": "KPI", "zh-HK": "KPI", en: "KPI" },
  "ecom.diagnostics.metric": { "zh-CN": "指标", "zh-HK": "指標", en: "Metric" },
  "ecom.diagnostics.value": { "zh-CN": "值", "zh-HK": "值", en: "Value" },
  "ecom.diagnostics.nd": { "zh-CN": "分子 / 分母", "zh-HK": "分子 / 分母", en: "Numerator / Denominator" },
  "ecom.pnl.amount": { "zh-CN": "金额", "zh-HK": "金額", en: "Amount" },
  "ecom.pnl.net_revenue": { "zh-CN": "净收入", "zh-HK": "淨收入", en: "Net revenue" },
  "ecom.pnl.subject": { "zh-CN": "科目", "zh-HK": "科目", en: "Line item" },
  "ecom.pnl.direction": { "zh-CN": "方向", "zh-HK": "方向", en: "Direction" },
  "ecom.pnl.metric": { "zh-CN": "指标", "zh-HK": "指標", en: "Metric" },
  "ecom.pnl.ad_spend_paid": { "zh-CN": "广告费(实付)", "zh-HK": "廣告費(實付)", en: "Ad spend (paid)" },
  "ecom.settlement.no_diffs": { "zh-CN": "无未对平差异——期间可进入 Approved 口径。", "zh-HK": "無未對平差異——期間可進入 Approved 口徑。", en: "No outstanding differences; the period may enter Approved basis." },
  "ecom.settlement.no_runs": { "zh-CN": "该期间还没有对账 run：先导入 payout / 银行流水与订单证据，再新建对账。", "zh-HK": "該期間還沒有對賬 run：先導入 payout / 銀行流水與訂單證據，再新建對賬。", en: "No reconciliation run yet: import payouts, bank lines and order evidence first." },
  "ecom.import.templates": { "zh-CN": "标准 CSV 模板", "zh-HK": "標準 CSV 模板", en: "Standard CSV templates" },
  "ecom.import.download": { "zh-CN": "下载模板", "zh-HK": "下載模板", en: "Download" },
  "ecom.import.preview": { "zh-CN": "校验预览", "zh-HK": "校驗預覽", en: "Preview" },
  "ecom.import.commit": { "zh-CN": "受控导入", "zh-HK": "受控導入", en: "Import" },
  "ecom.import.envelope_note": { "zh-CN": "信封字段（source_system / as_of_at / data_classification）随导入请求携带，缺任一整批拒绝。", "zh-HK": "信封字段（source_system / as_of_at / data_classification）隨導入請求攜帶，缺任一整批拒絕。", en: "Envelope fields travel with the request; a missing field rejects the whole batch." },
  "ecom.scenario.title": { "zh-CN": "大促保本情景", "zh-HK": "大促保本情景", en: "BFCM break-even" },
  "ecom.scenario.simulated_note": { "zh-CN": "情景输出全程 simulated 标识，永不混入正式口径。", "zh-HK": "情景輸出全程 simulated 標識，永不混入正式口徑。", en: "Scenario output is always simulated; never mixed into formal basis." },
  "ecom.scenario.cash_gap": { "zh-CN": "现金缺口提示（静态公式版）", "zh-HK": "現金缺口提示（靜態公式版）", en: "Cash gap hint (static formula)" },
  "ecom.scenario.base_cm1_rate": { "zh-CN": "CM1 率", "zh-HK": "CM1 率", en: "CM1 rate" },
  "ecom.scenario.ad_budget": { "zh-CN": "广告预算", "zh-HK": "廣告預算", en: "Ad budget" },
  "ecom.scenario.cpm": { "zh-CN": "CPM", "zh-HK": "CPM", en: "CPM" },
  "ecom.scenario.cpc": { "zh-CN": "CPC", "zh-HK": "CPC", en: "CPC" },
  "ecom.scenario.cvr": { "zh-CN": "CVR", "zh-HK": "CVR", en: "CVR" },
  "ecom.scenario.aov": { "zh-CN": "AOV", "zh-HK": "AOV", en: "AOV" },
  ...
  "category.load_failed": {
    "zh-CN": "品类事实加载失败", "zh-HK": "品類事實載入失敗", en: "Failed to load category facts",
  },
  ...
  "promotion.status_unknown": { "zh-CN": "未知状态", "zh-HK": "未知狀態", en: "Unknown status" },
  ...
  "scenario.scope_note": {
    "zh-CN": "门店经营 What-if；服务端基于同一 Working 事实重算 30 天日均折算值，不输出最优方案或 IFRS 16 影响。",
    "zh-HK": "門店經營 What-if；服務端基於同一 Working 事實重算 30 天日均折算值，不輸出最優方案或 IFRS 16 影響。",
  ...
  "scenario.loading": {
    "zh-CN": "服务端读取事实并计算 30 天日均折算值…",
    "zh-HK": "服務端讀取事實並計算 30 天日均折算值…",
  ...
  "scenario.evidence.formula": {
    "zh-CN": "公式：30 天日均折算值 = 30 ÷ 实际观测店天数；贡献额 = 毛利额 − 人工 − 经营占用现金成本 − 其他可控成本。经营占用现金成本不等同 IFRS 16 会计费用。",
    "zh-HK": "公式：30 天日均折算值 = 30 ÷ 實際觀測店天數；貢獻額 = 毛利額 − 人工 − 經營佔用現金成本 − 其他可控成本。經營佔用現金成本不等同 IFRS 16 會計費用。",
  ...
  // 情景决策 → 租赁事件草稿（POST /reports/store-decision-event-draft）：
  // 只写 draft 层，审批与重算仍是独立工作流；approved 必须由人显式确认。
  "scenario.event.open": { "zh-CN": "转为租赁事件草稿", "zh-HK": "轉為租賃事件草稿", en: "Convert to lease event draft" },
  "scenario.event.modal_title": { "zh-CN": "情景决策 → 租赁事件草稿", "zh-HK": "情景決策 → 租賃事件草稿", en: "Scenario decision → lease event draft" },
  "scenario.event.modal_desc": {
    "zh-CN": "把当前情景决策转成租赁事件草稿进入审批队列。只创建草稿，正式事件与重算在审批之后；测算快照会作为证据一并附上。",
    "zh-HK": "把當前情景決策轉成租賃事件草稿進入審批隊列。只創建草稿，正式事件與重算在審批之後；測算快照會作為證據一併附上。",
    en: "Turns the current scenario decision into a lease event draft for the approval queue. Only a draft is created — the formal event and recalculation follow approval; the evaluation snapshot is attached as evidence.",
  },
  "scenario.event.contract_placeholder": { "zh-CN": "合同 ID（该决策涉及的租赁合同）", "zh-HK": "合同 ID（該決策涉及的租賃合同）", en: "Contract ID (the lease this decision touches)" },
  "scenario.event.type_lease_modification": { "zh-CN": "租赁变更 (modification)", "zh-HK": "租賃變更 (modification)", en: "Lease modification" },
  "scenario.event.type_reassessment": { "zh-CN": "重新评估 (reassessment)", "zh-HK": "重新評估 (reassessment)", en: "Reassessment" },
  "scenario.event.type_fixed_rent_change": { "zh-CN": "固定租金变更", "zh-HK": "固定租金變更", en: "Fixed rent change" },
  "scenario.event.type_early_termination": { "zh-CN": "提前终止", "zh-HK": "提前終止", en: "Early termination" },
  "scenario.event.effective_date": { "zh-CN": "生效日期", "zh-HK": "生效日期", en: "Effective date" },
  "scenario.event.decision": { "zh-CN": "决策说明（默认取情景标题，可改）", "zh-HK": "決策說明（默認取情景標題，可改）", en: "Decision (defaults to the scenario title, editable)" },
  "scenario.event.change_reason": { "zh-CN": "变更原因", "zh-HK": "變更原因", en: "Change reason" },
  "scenario.event.original_value": { "zh-CN": "原值（可选）", "zh-HK": "原值（可選）", en: "Original value (optional)" },
  "scenario.event.new_value": { "zh-CN": "新值（可选）", "zh-HK": "新值（可選）", en: "New value (optional)" },
  "scenario.event.approved_label": { "zh-CN": "我确认该决策已经过审批", "zh-HK": "我確認該決策已經過審批", en: "I confirm this decision has been approved" },
  "scenario.event.approved_hint": {
    "zh-CN": "只有经过审批的决策才能创建租赁事件草稿；未经审批的提交会被拒绝。",
    "zh-HK": "只有經過審批的決策才能創建租賃事件草稿；未經審批的提交會被拒絕。",
    en: "Only an approved decision can create a lease event draft; unapproved submissions are refused.",
  },
  "scenario.event.submit": { "zh-CN": "创建事件草稿", "zh-HK": "建立事件草稿", en: "Create event draft" },
  "scenario.event.cancel": { "zh-CN": "取消", "zh-HK": "取消", en: "Cancel" },
  "scenario.event.success": { "zh-CN": "租赁事件草稿已创建", "zh-HK": "租賃事件草稿已建立", en: "Lease event draft created" },
  "scenario.event.success_title": { "zh-CN": "租赁事件草稿已进入审批队列", "zh-HK": "租賃事件草稿已進入審批隊列", en: "Lease event draft is in the approval queue" },
  "scenario.event.success_status": { "zh-CN": "草稿状态：{status}", "zh-HK": "草稿狀態：{status}", en: "Draft status: {status}" },
  "scenario.event.formal_created": { "zh-CN": "正式事件已被创建", "zh-HK": "正式事件已被建立", en: "A formal event was created" },
  "scenario.event.formal_not_created": {
    "zh-CN": "正式事件未创建（formal_event_created=false）——审批通过后才入正式事件链路",
    "zh-HK": "正式事件未建立（formal_event_created=false）——審批通過後才入正式事件鏈路",
    en: "No formal event was created (formal_event_created=false) — the formal event chain starts only after approval",
  },
  "scenario.event.err_contract": { "zh-CN": "请填写合同 ID", "zh-HK": "請填寫合同 ID", en: "Contract ID is required" },
  "scenario.event.err_date": { "zh-CN": "请选择生效日期", "zh-HK": "請選擇生效日期", en: "Effective date is required" },
  "scenario.event.err_reason": { "zh-CN": "请填写变更原因", "zh-HK": "請填寫變更原因", en: "Change reason is required" },
  "scenario.event.err_approved": { "zh-CN": "需先确认该决策已经过审批", "zh-HK": "需先確認該決策已經過審批", en: "Confirm the decision has been approved first" },
  ...
  "ai.page_fill.pending": { "zh-CN": "页面预填 · 待人工确认", "zh-HK": "頁面預填 · 待人工確認", en: "Page prefill · pending confirmation" },
  "ai.page_fill.suggestion": { "zh-CN": "AI 建议", "zh-HK": "AI 建議", en: "AI suggestion" },
  "ai.page_fill.confirmed": { "zh-CN": "已确认输入", "zh-HK": "已確認輸入", en: "Confirmed input" },
  "ai.page_fill.open": { "zh-CN": "打开目标页核对", "zh-HK": "打開目標頁核對", en: "Open target page to review" },
  "ai.page_fill.class_unknown": { "zh-CN": "未识别文件类型", "zh-HK": "未識別檔案類型", en: "Unresolved file type" },
  "ai.tool.failed": {
    "zh-CN": "失败",
    "zh-HK": "失敗",
    en: "Failed",
  ...
  // F1-4：数据标识（production/simulated）与版本态（Working/Official）是两个
  // 互不相关的坐标轴，不许焊在一个字符串里；版本态由 trust.basis_* 单独表达。
  ...
  // Retained for expanded audit detail and compatibility; the summary uses a
  // compact observed/expected count.
  "trust.store_days": {
    "zh-CN": "门店日",
    "zh-HK": "門店日",
    en: "store-days",
  ...
  "trust.basis_operating": {
    "zh-CN": "经营口径",
    "zh-HK": "經營口徑",
    en: "Operating view",
  },
  "trust.basis_scenario": {
    "zh-CN": "情景测算",
    "zh-HK": "情景測算",
    en: "Scenario view",
  },
  ...
  // F0-3：同业对标状态枚举 → 界面文案（取值全集 = storepnl/project.go PeerStatus）
  "storepnl.peer_status.complete": { "zh-CN": "样本充足", "zh-HK": "樣本充足", en: "Sufficient peers" },
  "storepnl.peer_status.insufficient_peers": { "zh-CN": "可比门店不足", "zh-HK": "可比門店不足", en: "Insufficient comparable stores" },
  "storepnl.peer_status.mixed_currency": { "zh-CN": "币种不可比", "zh-HK": "幣種不可比", en: "Currencies not comparable" },
  "storepnl.peer_status.unavailable": { "zh-CN": "暂无对标", "zh-HK": "暫無對標", en: "Benchmark unavailable" },
  "storepnl.peer_status_unknown": { "zh-CN": "未识别的对标状态", "zh-HK": "未識別的對標狀態", en: "Unrecognized benchmark status" },
  ...
  "storepnl.provenance": { "zh-CN": "来源信封", "zh-HK": "來源信封", en: "Source envelope" },
  "storepnl.days": { "zh-CN": "天", "zh-HK": "天", en: "d" },
  "storepnl.source_systems": { "zh-CN": "来源系统", "zh-HK": "來源系統", en: "Source systems" },
  "storepnl.import_batches": { "zh-CN": "导入批次", "zh-HK": "導入批次", en: "Import batches" },
  "storepnl.fact_versions": { "zh-CN": "事实版本", "zh-HK": "事實版本", en: "Fact versions" },
  "storepnl.source_envelope": { "zh-CN": "来源信封（Source Envelope）", "zh-HK": "來源信封（Source Envelope）", en: "Source Envelope" },
  "storepnl.formula_version": { "zh-CN": "公式版本", "zh-HK": "公式版本", en: "Formula version" },
  "storepnl.semantic_version": { "zh-CN": "语义层版本", "zh-HK": "語義層版本", en: "Semantic version" },
  "storepnl.row_settings": { "zh-CN": "行设置", "zh-HK": "行設置", en: "Row settings" },
  "storepnl.hide_rows": { "zh-CN": "隐藏行", "zh-HK": "隱藏行", en: "Hide rows" },
  "storepnl.fold_groups": { "zh-CN": "折叠分组", "zh-HK": "摺疊分組", en: "Fold groups" },
  "storepnl.save_view": { "zh-CN": "存为视图", "zh-HK": "存為視圖", en: "Save view" },
  "storepnl.my_views": { "zh-CN": "我的视图", "zh-HK": "我的視圖", en: "My views" },
  "storepnl.view_name": { "zh-CN": "视图名称", "zh-HK": "視圖名稱", en: "View name" },
  "storepnl.basic_rent": { "zh-CN": "基本租金", "zh-HK": "基本租金", en: "Basic rent" },
  "storepnl.service_fee": { "zh-CN": "服务费", "zh-HK": "服務費", en: "Service fee" },
  "storepnl.variable_rent": { "zh-CN": "变量租金", "zh-HK": "變量租金", en: "Variable rent" },
  "storepnl.col_budget": { "zh-CN": "Budget", "zh-HK": "Budget", en: "Budget" },
  "storepnl.col_forecast": { "zh-CN": "Forecast", "zh-HK": "Forecast", en: "Forecast" },
  "storepnl.col_prior_year": { "zh-CN": "Prior Year", "zh-HK": "Prior Year", en: "Prior year" },
  "storepnl.custom_formula": { "zh-CN": "自定义公式行", "zh-HK": "自訂公式行", en: "Custom formula row" },
  "storepnl.template_name": { "zh-CN": "模板名称（个人草稿）", "zh-HK": "模板名稱（個人草稿）", en: "Template name (personal draft)" },
  "storepnl.row_label": { "zh-CN": "行名称", "zh-HK": "行名稱", en: "Row label" },
  "storepnl.row_key": { "zh-CN": "行 key", "zh-HK": "行 key", en: "Row key" },
  "storepnl.formula_hint": { "zh-CN": "公式（仅支持受限语法，如 rows.revenue - rows.labor_cost；保存时校验）", "zh-HK": "公式（僅支持受限語法，如 rows.revenue - rows.labor_cost；保存時校驗）", en: "Formula (restricted syntax only, e.g. rows.revenue - rows.labor_cost; validated on save)" },
  ...
  "storepnl.not_ready": { "zh-CN": "未就绪（数据覆盖不足）", "zh-HK": "未就緒（數據覆蓋不足）", en: "Not decision-ready" },
  ...
  "storepnl.basis_note": { "zh-CN": "双口径并列永不合计：经营口径含占用成本，IFRS 16 口径含 ROU 折旧与租赁利息", "zh-HK": "雙口徑並列永不合計：經營口徑含佔用成本，IFRS 16 口徑含 ROU 折舊與租賃利息", en: "Two bases side by side, never summed: operating keeps occupancy cost, IFRS 16 keeps ROU depreciation and lease interest" },
  "nav.financial_model": { "zh-CN": "三表财务模型", "zh-HK": "三表財務模型", en: "Financial Model" },
  "finmodel.basis_note": { "zh-CN": "管理口径三表模型；勾稽未通过的测算不可发布", "zh-HK": "管理口徑三表模型；勾稽未通過的測算不可發佈", en: "Management-basis three-statement model; tie-outs must pass before publishing" },
  "finmodel.assumptions_hint": { "zh-CN": "用 JSON 键值对填写业务假设；下方逐条列出每个已知键的含义与计算口径。所有假设都会版本化留痕。", "zh-HK": "用 JSON 鍵值對填寫業務假設；下方逐條列出每個已知鍵的含義與計算口徑。所有假設都會版本化留痕。", en: "Fill business assumptions as a JSON object; the meaning and formula basis of each known key is listed below. Every assumption is versioned." },
  "finmodel.run": { "zh-CN": "运行模型", "zh-HK": "運行模型", en: "Run" },
  "finmodel.persisted": { "zh-CN": "已持久化（勾稽通过）", "zh-HK": "已持久化（勾稽通過）", en: "Persisted (tie-outs passed)" },
  ...
  "finmodel.tie_outs": { "zh-CN": "勾稽校验（T1–T16）", "zh-HK": "勾稽校驗（T1–T16）", en: "Tie-outs" },
  ...
  // 三表工作台重构（spec: docs/specs/financial_model_workbench_refactor.md）
  ...
  "finmodel.result_title": { "zh-CN": "运行结果", "zh-HK": "運行結果", en: "Run result" },
  "finmodel.publish": { "zh-CN": "发布计划版本", "zh-HK": "發佈計劃版本", en: "Publish plan version" },
  "finmodel.published": { "zh-CN": "已发布", "zh-HK": "已發佈", en: "Published" },
  "finmodel.export": { "zh-CN": "导出", "zh-HK": "匯出", en: "Export" },
  "finmodel.gaps": { "zh-CN": "缺口清单（每条具名并说明原因）", "zh-HK": "缺口清單（每條具名並說明原因）", en: "Named gaps (each states what is missing and why)" },
  "finmodel.tie_out_gate_note": { "zh-CN": "勾稽未全部通过：本次测算不能发布为计划版本", "zh-HK": "勾稽未全部通過：本次測算不能發佈為計劃版本", en: "Tie-outs are not all passed: this run cannot be published as a plan version" },
  "finmodel.opening_entity": { "zh-CN": "法人主体", "zh-HK": "法人主體", en: "Legal entity" },
  "finmodel.opening_currency": { "zh-CN": "币种", "zh-HK": "幣種", en: "Currency" },
  "finmodel.opening_policy": { "zh-CN": "合并政策版本", "zh-HK": "合併政策版本", en: "Merge policy version" },
  // 工作台文案层+交互层（spec 追加决策①②：BP 可读性 + 期闸目标流程）
  "finmodel.page_intro": { "zh-CN": "把经营假设推演成三张报表：先对账，再出数，后发布", "zh-HK": "把經營假設推演成三張報表：先對賬，再出數，後發佈", en: "Turn operating assumptions into three statements. Reconcile first, then project, then publish" },
  "finmodel.step_select_def": { "zh-CN": "① 选模型", "zh-HK": "① 選模型", en: "① Pick model" },
  "finmodel.card_hint_select_def": { "zh-CN": "从列表选择模型定义；列表为空时可直接粘贴定义 ID", "zh-HK": "從列表選擇模型定義；列表為空時可直接粘貼定義 ID", en: "Pick a model definition from the list; if it is empty, paste a definition ID directly" },
  "finmodel.step_assumptions": { "zh-CN": "② 填假设", "zh-HK": "② 填假設", en: "② Fill assumptions" },
  "finmodel.classification_label": { "zh-CN": "数据标识", "zh-HK": "數據標識", en: "Data classification" },
  // F1-4：数据标识与版本态拆开后，版本态标签的口径说明
  "finmodel.version_state_tooltip": { "zh-CN": "数据标识与版本态是两个独立维度：下拉选择的是数据来源（正式 / 模拟）；三表测算一律在工作底稿口径（Working）下进行，发布通过后生成计划版本。", "zh-HK": "數據標識與版本態是兩個獨立維度：下拉選擇的是數據來源（正式 / 模擬）；三表測算一律在工作底稿口徑（Working）下進行，發佈通過後生成計劃版本。", en: "Data classification and version state are two independent axes: the dropdown picks the data source (production / simulated); three-statement runs always use the Working basis, and publishing produces a plan version." },
  "finmodel.fill_example": { "zh-CN": "填充示例", "zh-HK": "填充示例", en: "Fill example" },
  "finmodel.example_filled": { "zh-CN": "已填入示例：可先运行体验流程，正式使用前请替换为真实值", "zh-HK": "已填入示例：可先運行體驗流程，正式使用前請替換為真實值", en: "Example filled. Run it to see the flow; replace with real values before real use" },
  "finmodel.hint_unknown": { "zh-CN": "未识别键（原样传给后端）", "zh-HK": "未識別鍵（原樣傳給後端）", en: "Unrecognized key (passed through as-is)" },
  "finmodel.step_opening": { "zh-CN": "③ 校期初", "zh-HK": "③ 校期初", en: "③ Verify opening" },
  "finmodel.card_hint_opening": { "zh-CN": "四步：选期间 → 引擎自动取数 → 导入上传 → 校验", "zh-HK": "四步：選期間 → 引擎自動取數 → 導入上傳 → 校驗", en: "Four steps: pick periods → engine auto-fetch → file import → validate" },
  "finmodel.gate1_label": { "zh-CN": "闸① 自平衡", "zh-HK": "閘① 自平衡", en: "Gate 1 · Self-balance" },
  "finmodel.gate1_tooltip": { "zh-CN": "每个期间的资产 = 负债 + 权益，容差 ±0.01", "zh-HK": "每個期間的資產 = 負債 + 權益，容差 ±0.01", en: "Assets = liabilities + equity for every period, tolerance ±0.01" },
  "finmodel.gate2_label": { "zh-CN": "闸② 归并一致", "zh-HK": "閘② 歸並一致", en: "Gate 2 · Merge stability" },
  "finmodel.gate2_tooltip": { "zh-CN": "同一外部科目在所有期间映射到同一标准行，不允许期间间漂移", "zh-HK": "同一外部科目在所有期間映射到同一標準行，不允許期間間漂移", en: "Each external account maps to one standard line across all periods. No drift between periods" },
  "finmodel.gate3_label": { "zh-CN": "闸③ 租赁对照", "zh-HK": "閘③ 租賃對照", en: "Gate 3 · Lease reconciliation" },
  "finmodel.gate3_tooltip": { "zh-CN": "导入口径与引擎口径的逐合约租赁余额必须完全一致（引擎是唯一权威）", "zh-HK": "導入口徑與引擎口徑的逐合約租賃餘額必須完全一致（引擎是唯一權威）", en: "Per-contract lease balances must match the engine exactly. The engine is the single authority" },
  "finmodel.opening_step1": { "zh-CN": "第 1 步 · 选择要校验的期间", "zh-HK": "第 1 步 · 選擇要校驗的期間", en: "Step 1 · Pick periods to verify" },
  "finmodel.opening_period_placeholder": { "zh-CN": "输入期间（如 2026-01）后回车添加", "zh-HK": "輸入期間（如 2026-01）後回車添加", en: "Type a period (e.g. 2026-01) and press Enter" },
  "finmodel.opening_add_period": { "zh-CN": "添加期间", "zh-HK": "添加期間", en: "Add period" },
  "finmodel.opening_step2": { "zh-CN": "第 2 步 · 引擎侧自动取数", "zh-HK": "第 2 步 · 引擎側自動取數", en: "Step 2 · Auto-fetch from the engine" },
  "finmodel.opening_auto_unavailable": { "zh-CN": "自动取数尚未开放：上线后将自动读取计量结果与上期测算的期初余额；当前请在下方「高级」手动填写余额与合约行", "zh-HK": "自動取數尚未開放：上線後將自動讀取計量結果與上期測算的期初餘額；當前請在下方「高級」手動填寫餘額與合約行", en: "Auto-fetch is not available yet: once live, opening balances come straight from measurement results and the prior run; for now, enter balances and contract rows manually under Advanced below" },
  "finmodel.opening_step3": { "zh-CN": "第 3 步 · 导入侧上传", "zh-HK": "第 3 步 · 導入側上傳", en: "Step 3 · Import-side upload" },
  "finmodel.opening_import_unavailable": { "zh-CN": "文件上传尚未开放：上线后可直接上传导出的期初余额文件；当前请在下方「高级」手动填写", "zh-HK": "文件上傳尚未開放：上線後可直接上傳導出的期初餘額文件；當前請在下方「高級」手動填寫", en: "File upload is not available yet: once live, you can upload the exported opening-balance file directly; for now, use Advanced below" },
  "finmodel.opening_step4": { "zh-CN": "第 4 步 · 校验", "zh-HK": "第 4 步 · 校驗", en: "Step 4 · Validate" },
  "finmodel.opening_advanced": { "zh-CN": "高级：手动填写余额与合约行", "zh-HK": "高級：手動填寫餘額與合約行", en: "Advanced: enter balances and contract rows manually" },
  "finmodel.balances_json_placeholder": { "zh-CN": "{\"2026-01\": {\"lines\": {\"cash\": 800000}, \"mapping\": {\"1001\": \"cash\"}}}", "zh-HK": "{\"2026-01\": {\"lines\": {\"cash\": 800000}, \"mapping\": {\"1001\": \"cash\"}}}", en: "{\"2026-01\": {\"lines\": {\"cash\": 800000}, \"mapping\": {\"1001\": \"cash\"}}}" },
  "finmodel.opening_no_periods": { "zh-CN": "至少选择一个期间再校验", "zh-HK": "至少選擇一個期間再校驗", en: "Pick at least one period before validating" },
  "finmodel.opening_bad_balances": { "zh-CN": "余额 JSON 不合法：应为 {期间:{lines,mapping}}，lines 为数值、mapping 为字符串", "zh-HK": "餘額 JSON 不合法：應為 {期間:{lines,mapping}}，lines 為數值、mapping 為字符串", en: "Balances JSON is invalid: expected {period:{lines,mapping}} with numeric lines and string mapping values" },
  "finmodel.opening_missing_balance": { "zh-CN": "已选期间在高级余额中没有记录——补齐该期间，或删除该期间", "zh-HK": "已選期間在高級餘額中沒有記錄——補齊該期間，或刪除該期間", en: "A selected period has no balances entry under Advanced. Add it there, or remove the period" },
  "finmodel.step_run": { "zh-CN": "④ 运行", "zh-HK": "④ 運行", en: "④ Run" },
  "finmodel.step_publish_export": { "zh-CN": "⑤ 发布与导出", "zh-HK": "⑤ 發佈與匯出", en: "⑤ Publish & export" },
  // F0-2：机器枚举 → 界面文案（键集由 enums.ts 的联合类型 Record 锁定）
  "finmodel.run_status.queued": { "zh-CN": "排队中", "zh-HK": "排隊中", en: "Queued" },
  "finmodel.run_status.running": { "zh-CN": "运行中", "zh-HK": "運行中", en: "Running" },
  "finmodel.run_status.completed": { "zh-CN": "已完成", "zh-HK": "已完成", en: "Completed" },
  "finmodel.run_status.failed": { "zh-CN": "失败", "zh-HK": "失敗", en: "Failed" },
  "finmodel.run_status.cancelled": { "zh-CN": "已取消", "zh-HK": "已取消", en: "Cancelled" },
  "finmodel.tie_out.pending": { "zh-CN": "待判定", "zh-HK": "待判定", en: "Pending" },
  "finmodel.tie_out.passed": { "zh-CN": "全部通过", "zh-HK": "全部通過", en: "All passed" },
  "finmodel.tie_out.failed": { "zh-CN": "存在未通过项", "zh-HK": "存在未通過項", en: "Failed checks present" },
  "finmodel.tie_out.degraded": { "zh-CN": "部分降级（数据不足）", "zh-HK": "部分降級（數據不足）", en: "Partly degraded (insufficient data)" },
  "finmodel.grain.month": { "zh-CN": "月", "zh-HK": "月", en: "Month" },
  "finmodel.grain.quarter": { "zh-CN": "季", "zh-HK": "季", en: "Quarter" },
  "finmodel.grain.year": { "zh-CN": "年", "zh-HK": "年", en: "Year" },
  "finmodel.gap_kind_unknown": { "zh-CN": "未识别的缺口类型", "zh-HK": "未識別的缺口類型", en: "Unrecognized gap type" },
  "finmodel.gap.opening_missing": { "zh-CN": "未提供期初余额", "zh-HK": "未提供期初餘額", en: "Opening balance not provided" },
  "finmodel.gap.fact_port_unavailable": { "zh-CN": "经营事实端口未接线", "zh-HK": "經營事實端口未接線", en: "Facts port not wired" },
  "finmodel.gap.fact_coverage": { "zh-CN": "经营事实覆盖不足", "zh-HK": "經營事實覆蓋不足", en: "Fact coverage insufficient" },
  "finmodel.gap.fact_missing": { "zh-CN": "经营事实缺失", "zh-HK": "經營事實缺失", en: "Operating fact missing" },
  "finmodel.gap.lease_port_unavailable": { "zh-CN": "租赁投影端口未接线", "zh-HK": "租賃投影端口未接線", en: "Lease projection port not wired" },
  "finmodel.gap.schedule_port_unavailable": { "zh-CN": "付款计划端口未接线", "zh-HK": "付款計劃端口未接線", en: "Payment schedule port not wired" },
  "finmodel.gap.assumption_port_unavailable": { "zh-CN": "假设端口未接线", "zh-HK": "假設端口未接線", en: "Assumptions port not wired" },
  "finmodel.gap.assumption_missing": { "zh-CN": "假设未登记", "zh-HK": "假設未登記", en: "Assumption not registered" },
  "finmodel.gap.unregistered_source": { "zh-CN": "模板行绑定了未登记数据源", "zh-HK": "模板行绑定了未登記數據源", en: "Template row bound to an unregistered source" },
  "finmodel.gap.forecast_driver_missing": { "zh-CN": "预测驱动假设缺失", "zh-HK": "預測驅動假設缺失", en: "Forecast driver missing" },
  "finmodel.gap.revenue_driver_note": { "zh-CN": "营收驱动说明", "zh-HK": "營收驅動說明", en: "Revenue driver note" },
  "finmodel.gap.interest_presentation_missing": { "zh-CN": "利息列报调整所需行缺失", "zh-HK": "利息列報調整所需行缺失", en: "Line required for interest presentation is missing" },
  "finmodel.gap.subtotal_partial": { "zh-CN": "小计遇缺失子行，部分降级", "zh-HK": "小計遇缺失子行，部分降級", en: "Subtotal degraded by missing child rows" },
  "finmodel.opening_lease_ref": { "zh-CN": "导入口径合约余额（lease_ref）", "zh-HK": "導入口徑合約餘額（lease_ref）", en: "Imported contract balances (lease_ref)" },
  "finmodel.opening_engine": { "zh-CN": "引擎口径合约余额（engine）", "zh-HK": "引擎口徑合約餘額（engine）", en: "Engine contract balances (engine)" },
  "finmodel.coa_key": { "zh-CN": "科目键", "zh-HK": "科目鍵", en: "Account key" },
  "finmodel.coa_label": { "zh-CN": "名称", "zh-HK": "名稱", en: "Name" },
  "finmodel.coa_reserved": { "zh-CN": "预置", "zh-HK": "預置", en: "Preset" },
  "finmodel.coa_zero": { "zh-CN": "已确认为零", "zh-HK": "已確認為零", en: "Confirmed zero" },
  "finmodel.coa_manual": { "zh-CN": "自填", "zh-HK": "自填", en: "Manual input" },
  "finmodel.coa_unmark_zero": { "zh-CN": "撤销确认为零", "zh-HK": "撤銷確認為零", en: "Unmark confirmed zero" },
  "finmodel.coa_mark_zero": { "zh-CN": "确认为零", "zh-HK": "確認為零", en: "Confirm zero" },
  "finmodel.coa_ai_source": { "zh-CN": "AI 生成草稿 · 待人工确认", "zh-HK": "AI 生成草稿 · 待人工確認", en: "AI-generated draft · pending human confirmation" },
  "finmodel.coa_zero_note": { "zh-CN": "已确认为零的科目（HumanInput，与缺失分离）", "zh-HK": "已確認為零的科目（HumanInput，與缺失分離）", en: "Accounts confirmed as zero (HumanInput, distinct from missing)" },
  "finmodel.coa_new_key": { "zh-CN": "科目键", "zh-HK": "科目鍵", en: "Account key" },
  "finmodel.coa_new_label": { "zh-CN": "名称", "zh-HK": "名稱", en: "Name" },
  "finmodel.coa_parent": { "zh-CN": "父小计（必选）", "zh-HK": "父小計（必選）", en: "Parent subtotal (required)" },
  "finmodel.coa_parent_placeholder": { "zh-CN": "选择子计行", "zh-HK": "選擇子計行", en: "Choose a subtotal row" },
  "finmodel.coa_fold": { "zh-CN": "存量/流量", "zh-HK": "存量/流量", en: "Stock / flow" },
  "finmodel.coa_fold_required": { "zh-CN": "该父小计属于资产负债表科目：必须声明存量或流量（不给默认值）", "zh-HK": "該父小計屬於資產負債表科目：必須聲明存量或流量（不給默認值）", en: "This parent is a balance-sheet subject: declare stock or flow (no default)" },
  "finmodel.coa_add": { "zh-CN": "新增科目", "zh-HK": "新增科目", en: "Add account" },
  "finmodel.coa_footer": { "zh-CN": "公式行的校验在保存时经后端 templates/validate 完成；前端不做本地解析。", "zh-HK": "公式行的校驗在保存時經後端 templates/validate 完成；前端不做本地解析。", en: "Formula rows are validated via backend templates/validate on save; the frontend performs no local parsing." },
  "finmodel.coa.editor_title": { "zh-CN": "科目树编辑器", "zh-HK": "科目樹編輯器", en: "Chart of accounts editor" },
  "finmodel.coa_load_failed": { "zh-CN": "科目树加载失败", "zh-HK": "科目樹載入失敗", en: "Failed to load the chart of accounts" },
  "finmodel.coa_login": { "zh-CN": "登录后使用科目树编辑器", "zh-HK": "登入後使用科目樹編輯器", en: "Sign in to use the chart of accounts editor" },
  "finmodel.coa_loading": { "zh-CN": "科目树加载中", "zh-HK": "科目樹載入中", en: "Loading the chart of accounts" },
  "finmodel.coa_no_draft_selected": { "zh-CN": "没有可保存的草稿模板", "zh-HK": "沒有可保存的草稿模板", en: "No draft template to save" },
  "finmodel.coa_save_failed": { "zh-CN": "科目树保存失败", "zh-HK": "科目樹保存失敗", en: "Failed to save the chart of accounts" },
  "finmodel.coa_empty": { "zh-CN": "暂无 draft 模板：先在上方创建或复制一份科目树草稿", "zh-HK": "暫無 draft 模板：先在上方建立或複製一份科目樹草稿", en: "No draft template yet: create or copy one first" },
  "finmodel.coa_err_missing_key": { "zh-CN": "科目键必填", "zh-HK": "科目鍵必填", en: "Account key is required" },
  "finmodel.coa_err_missing_label": { "zh-CN": "科目名称必填", "zh-HK": "科目名稱必填", en: "Account name is required" },
  "finmodel.coa_err_reserved_conflict": { "zh-CN": "与预置科目键冲突", "zh-HK": "與預置科目鍵衝突", en: "Conflicts with a preset account key" },
  "finmodel.coa_err_duplicate": { "zh-CN": "科目键已存在", "zh-HK": "科目鍵已存在", en: "Account key already exists" },
  "finmodel.coa_err_parent_required": { "zh-CN": "必须选择父小计", "zh-HK": "必須選擇父小計", en: "A parent subtotal is required" },
  "finmodel.coa_err_parent_not_subtotal": { "zh-CN": "父行必须是子计行（subtotal）", "zh-HK": "父行必須是子計行（subtotal）", en: "Parent row must be a subtotal" },
  "finmodel.coa_err_delete_reserved": { "zh-CN": "无法删除", "zh-HK": "無法刪除", en: "Cannot delete" },
  "finmodel.coa_dimension_hint": { "zh-CN": "「{value}」已是系统维度：跨维度的同一科目建议用维度筛选表达，而不是为每个地区/品牌复制一个科目", "zh-HK": "「{value}」已是系統維度：跨維度的同一科目建議用維度篩選表達，而不是為每個地區/品牌複製一個科目", en: '"{value}" is already a system dimension: prefer dimension filters over duplicating accounts per region/brand' },
  "finmodel.coa_reserved_reason": { "zh-CN": "保留键是资产负债表勾稽的读取点，删除或改键后 T1–T16 无法运行", "zh-HK": "保留鍵是資產負債表勾稽的讀取點，刪除或改鍵後 T1–T16 無法運行", en: "Reserved keys are balance-sheet tie-out read points; removing or renaming one breaks T1-T16" },
  "finmodel.coa_col_key": { "zh-CN": "科目键", "zh-HK": "科目鍵", en: "Key" },
  "finmodel.coa_col_label": { "zh-CN": "名称", "zh-HK": "名稱", en: "Name" },
  "finmodel.col_source": { "zh-CN": "取数", "zh-HK": "取數", en: "Source" },
  "finmodel.col_stock_flow": { "zh-CN": "存量/流量", "zh-HK": "存量/流量", en: "Stock / flow" },
  "finmodel.col_actions": { "zh-CN": "操作", "zh-HK": "操作", en: "Actions" },
  "finmodel.coa_delete": { "zh-CN": "删除", "zh-HK": "刪除", en: "Delete" },
  "finmodel.coa_kind_formula": { "zh-CN": "公式", "zh-HK": "公式", en: "Formula" },
  "finmodel.coa_kind_manual": { "zh-CN": "自填", "zh-HK": "自填", en: "Manual input" },
  "finmodel.coa_kind_subtotal_items": { "zh-CN": "子项", "zh-HK": "子項", en: "children" },
  "finmodel.fold_stock": { "zh-CN": "存量", "zh-HK": "存量", en: "Stock" },
  "finmodel.fold_flow": { "zh-CN": "流量", "zh-HK": "流量", en: "Flow" },
  "finmodel.add_row": { "zh-CN": "添加行", "zh-HK": "添加行", en: "Add row" },
  "finmodel.add_row_hint": { "zh-CN": "暂无合约行——点击右上角添加；两侧都留空表示跳过对应闸的对照", "zh-HK": "暫無合約行——點擊右上角添加；兩側都留空表示跳過對應閘的對照", en: "No contract rows yet. Add from the corner; leaving both sides empty skips that gate's comparison" },
  "finmodel.remove": { "zh-CN": "删除该行", "zh-HK": "刪除該行", en: "Remove row" },
  "finmodel.opening_contract": { "zh-CN": "合约编号 / ID", "zh-HK": "合約編號 / ID", en: "Contract number / ID" },
  "finmodel.opening_liability": { "zh-CN": "租赁负债", "zh-HK": "租賃負債", en: "Lease liability" },
  "finmodel.opening_rou": { "zh-CN": "使用权资产", "zh-HK": "使用權資產", en: "ROU asset" },
  // F0-1：placeholder 降级为填写示例，字段语义由可视 label 承担
  "finmodel.opening_contract_example": { "zh-CN": "如 CT-2026-001", "zh-HK": "如 CT-2026-001", en: "e.g. CT-2026-001" },
  "finmodel.opening_liability_example": { "zh-CN": "如 3200000.00", "zh-HK": "如 3200000.00", en: "e.g. 3200000.00" },
  "finmodel.opening_rou_example": { "zh-CN": "如 3255676.79", "zh-HK": "如 3255676.79", en: "e.g. 3255676.79" },
  "finmodel.opening_invalid": { "zh-CN": "表单不完整：请填写主体、币种并补全每一行合约余额", "zh-HK": "表單不完整：請填寫主體、幣種並補全每一行合約餘額", en: "Form incomplete. Fill entity, currency and every contract-balance row" },
  "finmodel.hint.sssg": { "zh-CN": "同店销售增长率——预测期收入 = 上期收入 × (1 + sssg)", "zh-HK": "同店銷售增長率——預測期收入 = 上期收入 × (1 + sssg)", en: "Same-store sales growth. Forecast revenue = prior revenue × (1 + sssg)" },
  "finmodel.hint.labor_cost_growth": { "zh-CN": "人工成本增长率——预测期人工成本按同法驱动", "zh-HK": "人工成本增長率——預測期人工成本按同法驅動", en: "Labor cost growth. Drives forecast-period labor cost" },
  "finmodel.hint.fixed_rent_growth": { "zh-CN": "固定租金增长率——预测期固定租金驱动假设", "zh-HK": "固定租金增長率——預測期固定租金驅動假設", en: "Fixed rent growth. Drives forecast-period fixed rent" },
  "finmodel.hint.variable_rent_growth": { "zh-CN": "变量租金增长率——预测期变量租金驱动假设", "zh-HK": "變量租金增長率——預測期變量租金驅動假設", en: "Variable rent growth. Drives forecast-period variable rent" },
  "finmodel.hint.non_lease_cost_growth": { "zh-CN": "非租赁物业费用增长率——预测期非租赁成本驱动假设", "zh-HK": "非租賃物業費用增長率——預測期非租賃成本驅動假設", en: "Non-lease property cost growth. Drives forecast-period cost" },
  "finmodel.hint.other_controllable_cost_growth": { "zh-CN": "其他可控成本增长率——预测期可控成本驱动假设", "zh-HK": "其他可控成本增長率——預測期可控成本驅動假設", en: "Other controllable cost growth. Drives forecast-period cost" },
  "finmodel.hint.ramp_factor": { "zh-CN": "新店爬坡因子——组合驱动项，未登记时按中性 1.0 处理", "zh-HK": "新店爬坡因子——組合驅動項，未登記時按中性 1.0 處理", en: "New-store ramp factor. Combined driver; neutral 1.0 when unregistered" },
  "finmodel.hint.store_count_growth": { "zh-CN": "门店数量增减——组合驱动项，未登记时按中性 1.0 处理", "zh-HK": "門店數量增減——組合驅動項，未登記時按中性 1.0 處理", en: "Store count change. Combined driver; neutral 1.0 when unregistered" },
  "finmodel.hint.gross_margin_rate": { "zh-CN": "毛利率——毛利 = 营业收入 × 毛利率", "zh-HK": "毛利率——毛利 = 營業收入 × 毛利率", en: "Gross margin rate. Gross profit = revenue × rate" },
  "finmodel.hint.borrow_interest_rate": { "zh-CN": "借款利率——借款利息 = 期初借款余额 × 利率", "zh-HK": "借款利率——借款利息 = 期初借款餘額 × 利率", en: "Borrowing rate. Interest = opening borrowings × rate" },
  "finmodel.hint.tax_rate": { "zh-CN": "有效税率——所得税 = 税前利润 × 有效税率", "zh-HK": "有效稅率——所得稅 = 稅前利潤 × 有效稅率", en: "Effective tax rate. Tax = pretax profit × rate" },
  "finmodel.hint.dividend_payout_rate": { "zh-CN": "股利支付率——股利 = 净利润 × 支付率", "zh-HK": "股利支付率——股利 = 淨利潤 × 支付率", en: "Dividend payout ratio. Dividends = net income × ratio" },
  "finmodel.hint.dso": { "zh-CN": "应收账款周转天数——应收 = DSO × 收入 ÷ 期间天数", "zh-HK": "應收賬款周轉天數——應收 = DSO × 收入 ÷ 期間天數", en: "Days sales outstanding. AR = DSO × revenue ÷ days" },
  "finmodel.hint.dio": { "zh-CN": "存货周转天数——存货 = DIO × 成本 ÷ 期间天数", "zh-HK": "存貨周轉天數——存貨 = DIO × 成本 ÷ 期間天數", en: "Days inventory outstanding. Inventory = DIO × cost ÷ days" },
  "finmodel.hint.dpo": { "zh-CN": "应付账款周转天数——应付 = DPO × 成本 ÷ 期间天数", "zh-HK": "應付賬款周轉天數——應付 = DPO × 成本 ÷ 期間天數", en: "Days payables outstanding. AP = DPO × cost ÷ days" },
  "finmodel.hint.days": { "zh-CN": "期间天数——DSO/DIO/DPO 的换算基数", "zh-HK": "期間天數——DSO/DIO/DPO 的換算基數", en: "Period days. Conversion base for DSO/DIO/DPO" },
  "finmodel.hint.allocation": { "zh-CN": "分摊与总部费用——直接输入行", "zh-HK": "分攤與總部費用——直接輸入行", en: "Allocated & HQ expenses. Direct input row" },
  "finmodel.hint.marketing": { "zh-CN": "营销费用（门店级）——直接输入行", "zh-HK": "營銷費用（門店級）——直接輸入行", en: "Marketing expense (store level). Direct input row" },
  // F3-1：假设键值表单（单位换算只在展示层；单位登记见 hints.ts ASSUMPTION_UNITS）
  "finmodel.unit.percent": { "zh-CN": "%", "zh-HK": "%", en: "%" },
  "finmodel.unit.days": { "zh-CN": "天", "zh-HK": "天", en: "days" },
  "finmodel.unit.multiple": { "zh-CN": "倍", "zh-HK": "倍", en: "×" },
  "finmodel.unit.amount": { "zh-CN": "金额", "zh-HK": "金額", en: "amount" },
  "finmodel.assumption_name.sssg": { "zh-CN": "同店销售增长率", "zh-HK": "同店銷售增長率", en: "Same-store sales growth" },
  "finmodel.assumption_name.store_count_growth": { "zh-CN": "门店数量增减", "zh-HK": "門店數量增減", en: "Store count change" },
  "finmodel.assumption_name.ramp_factor": { "zh-CN": "新店爬坡因子", "zh-HK": "新店爬坡因子", en: "New-store ramp factor" },
  "finmodel.assumption_name.labor_cost_growth": { "zh-CN": "人工成本增长率", "zh-HK": "人工成本增長率", en: "Labor cost growth" },
  "finmodel.assumption_name.fixed_rent_growth": { "zh-CN": "固定租金增长率", "zh-HK": "固定租金增長率", en: "Fixed rent growth" },
  "finmodel.assumption_name.variable_rent_growth": { "zh-CN": "变量租金增长率", "zh-HK": "變量租金增長率", en: "Variable rent growth" },
  "finmodel.assumption_name.non_lease_cost_growth": { "zh-CN": "非租赁物业费用增长率", "zh-HK": "非租賃物業費用增長率", en: "Non-lease property cost growth" },
  "finmodel.assumption_name.other_controllable_cost_growth": { "zh-CN": "其他可控成本增长率", "zh-HK": "其他可控成本增長率", en: "Other controllable cost growth" },
  "finmodel.assumption_name.gross_margin_rate": { "zh-CN": "毛利率", "zh-HK": "毛利率", en: "Gross margin rate" },
  "finmodel.assumption_name.borrow_interest_rate": { "zh-CN": "借款利率", "zh-HK": "借款利率", en: "Borrowing rate" },
  "finmodel.assumption_name.tax_rate": { "zh-CN": "有效税率", "zh-HK": "有效稅率", en: "Effective tax rate" },
  "finmodel.assumption_name.dividend_payout_rate": { "zh-CN": "股利支付率", "zh-HK": "股利支付率", en: "Dividend payout ratio" },
  "finmodel.assumption_name.dso": { "zh-CN": "应收账款周转天数（DSO）", "zh-HK": "應收賬款周轉天數（DSO）", en: "Days sales outstanding (DSO)" },
  "finmodel.assumption_name.dio": { "zh-CN": "存货周转天数（DIO）", "zh-HK": "存貨周轉天數（DIO）", en: "Days inventory outstanding (DIO)" },
  "finmodel.assumption_name.dpo": { "zh-CN": "应付账款周转天数（DPO）", "zh-HK": "應付賬款周轉天數（DPO）", en: "Days payables outstanding (DPO)" },
  "finmodel.assumption_name.days": { "zh-CN": "期间天数", "zh-HK": "期間天數", en: "Period days" },
  "finmodel.assumption_name.marketing": { "zh-CN": "营销费用（门店级·月）", "zh-HK": "營銷費用（門店級·月）", en: "Marketing expense (store level, monthly)" },
  "finmodel.assumption_name.allocation": { "zh-CN": "分摊与总部费用（月）", "zh-HK": "分攤與總部費用（月）", en: "Allocated & HQ expenses (monthly)" },
  "finmodel.form_label": { "zh-CN": "业务假设", "zh-HK": "業務假設", en: "Business assumptions" },
  "finmodel.form_note": { "zh-CN": "留空 = 不提供该假设（引擎按未登记降级，不补 0）。所有假设版本化留痕。", "zh-HK": "留空 = 不提供該假設（引擎按未登記降級，不補 0）。所有假設版本化留痕。", en: "Leave blank to omit an assumption (the engine degrades explicitly instead of filling 0). Every assumption is versioned." },
  "finmodel.assumptions_advanced": { "zh-CN": "高级：粘贴 JSON", "zh-HK": "高級：粘貼 JSON", en: "Advanced: paste JSON" },
  ...
  "plan.title": { "zh-CN": "实际与预算", "zh-HK": "實際與預算", en: "Actual and budget" },
  "plan.absent_title": { "zh-CN": "本法人当前月份没有可对比的计划", "zh-HK": "本法人當前月份沒有可對比的計劃", en: "No comparable plan covers this month" },
  "plan.absent_desc": { "zh-CN": "需要有覆盖该月的预算或预测计划。没有计划时不构造对比数字。", "zh-HK": "需要有覆蓋該月的預算或預測計劃。沒有計劃時不構造對比數字。", en: "A budget or forecast must cover this month. Without one, no comparison values are constructed." },
  ...
  "plan.actual_classification": { "zh-CN": "Actual 分类", "zh-HK": "Actual 分類", en: "Actual classification" },
  "plan.budget_classification": { "zh-CN": "Budget 分类", "zh-HK": "Budget 分類", en: "Budget classification" },
  "plan.budget": { "zh-CN": "预算", "zh-HK": "預算", en: "Budget" },
  "plan.budget_version_missing": { "zh-CN": "暂无预算版本", "zh-HK": "暫無預算版本", en: "No budget version" },
  "plan.not_available": { "zh-CN": "预算对比不可用", "zh-HK": "預算對比不可用", en: "Budget comparison unavailable" },
  "plan.metric": { "zh-CN": "指标", "zh-HK": "指標", en: "Metric" },
  "plan.region": { "zh-CN": "区域", "zh-HK": "區域", en: "Region" },
  "plan.brand": { "zh-CN": "品牌", "zh-HK": "品牌", en: "Brand" },
  "plan.variance_amount": { "zh-CN": "差异额", "zh-HK": "差異額", en: "Variance" },
  "plan.variance_rate": { "zh-CN": "差异率", "zh-HK": "差異率", en: "Variance %" },
  "plan.missing_budget_reason": { "zh-CN": "当前期间缺少对应预算行", "zh-HK": "當前期間缺少對應預算行", en: "No matching Budget line covers this period" },
  "plan.unavailable_reason": { "zh-CN": "当前口径无法形成可比数字", "zh-HK": "當前口徑無法形成可比數字", en: "No comparable value is available on this basis" },
  "plan.mixed_currency_title": { "zh-CN": "存在币种混杂", "zh-HK": "存在幣種混雜", en: "Mixed currencies detected" },
  "plan.cross_currency_total": { "zh-CN": "跨币种合计", "zh-HK": "跨幣種合計", en: "Cross-currency total" },
  "plan.mixed_currency_reason": { "zh-CN": "已按币种分区展示，不生成跨币种合计", "zh-HK": "已按幣種分區展示，不生成跨幣種合計", en: "Values are partitioned by currency; no cross-currency total is produced" },
  "plan.no_comparable_rows": { "zh-CN": "没有可比指标；缺失值不会填 0", "zh-HK": "沒有可比指標；缺失值不會填 0", en: "No comparable metrics; missing values are not filled with zero" },
  "plan.not_ready": { "zh-CN": "对比不可决策", "zh-HK": "對比不可決策", en: "Comparison not decision-ready" },
  "plan.show_comparison": { "zh-CN": "显示对比", "zh-HK": "顯示對比", en: "Show comparison" },
  "plan.hide_comparison": { "zh-CN": "隐藏对比", "zh-HK": "隱藏對比", en: "Hide comparison" },
  "plan.toggle_comparison": { "zh-CN": "切换预算对比", "zh-HK": "切換預算對比", en: "Toggle budget comparison" },
  ...
  "pf.mode_official": { "zh-CN": "正式口径只包含已审批合同", "zh-HK": "正式口徑只包含已審批合同", en: "Official view covers approved contracts only" },
  "pf.mode_working": { "zh-CN": "内部口径包含草稿、复核中和已审批合同", "zh-HK": "內部口徑包含草稿、覆核中和已審批合同", en: "Internal view includes drafts, in review, and approved contracts" },
  ...
  "plan_import.type_budget": { "zh-CN": "预算版本", "zh-HK": "預算版本", en: "Budget" },
  "plan_import.type_forecast": { "zh-CN": "滚动预测", "zh-HK": "滾動預測", en: "Forecast" },
  "plan_import.type_scenario": { "zh-CN": "测算方案", "zh-HK": "測算方案", en: "Scenario" },
  ...
  // R0-2：行动清单枚举译名（键集 = fpna_action_items CHECK 约束 + 后端已写入的 category 字面量）
  "perf.sev.critical": { "zh-CN": "严重", "zh-HK": "嚴重", en: "Critical" },
  "perf.sev.high": { "zh-CN": "高", "zh-HK": "高", en: "High" },
  "perf.sev.medium": { "zh-CN": "中", "zh-HK": "中", en: "Medium" },
  "perf.sev.low": { "zh-CN": "低", "zh-HK": "低", en: "Low" },
  "perf.sev.informational": { "zh-CN": "提示", "zh-HK": "提示", en: "Info" },
  "perf.action_status.open": { "zh-CN": "待处理", "zh-HK": "待處理", en: "Open" },
  "perf.action_status.acknowledged": { "zh-CN": "已确认", "zh-HK": "已確認", en: "Acknowledged" },
  "perf.action_status.in_progress": { "zh-CN": "进行中", "zh-HK": "進行中", en: "In progress" },
  "perf.action_status.completed": { "zh-CN": "已完成", "zh-HK": "已完成", en: "Completed" },
  "perf.action_status.verified": { "zh-CN": "已验证", "zh-HK": "已驗證", en: "Verified" },
  "perf.action_status.accepted": { "zh-CN": "已采纳", "zh-HK": "已採納", en: "Accepted" },
  "perf.action_status.dismissed": { "zh-CN": "已搁置", "zh-HK": "已擱置", en: "Dismissed" },
  "perf.category.variance_explanation": { "zh-CN": "差异解释", "zh-HK": "差異解釋", en: "Variance explanation" },
  "perf.category.retail_store_scenario": { "zh-CN": "门店方案测算", "zh-HK": "門店方案測算", en: "Store scenario plan" },
  "perf.category.unrecognized": { "zh-CN": "未识别类别", "zh-HK": "未識別類別", en: "Unrecognized category" },
  "perf.enum.unrecognized": { "zh-CN": "未识别", "zh-HK": "未識別", en: "Unrecognized" },
  "store360.currency_status.known": { "zh-CN": "单一币种", "zh-HK": "單一幣種", en: "Single currency" },
  ...
  // Retained for help content and compatibility; page headers do not render
  // secondary scope copy.
  "perf.scope_note": {
  ...
  // R2-1：投前保本。result/sacrifice/unachievable/basis 为工单定稿，不改写。
  "promotion.breakeven.tab": { "zh-CN": "投前保本", "zh-HK": "投前保本", en: "Pre-launch breakeven" },
  "promotion.breakeven.title": { "zh-CN": "这次活动至少要多卖多少才不亏", "zh-HK": "這次活動至少要多賣多少才不虧", en: "How much more this promo must sell to break even" },
  "promotion.breakeven.result": {
    "zh-CN": "保本增量销售额 {amount}，相当于比基线多卖 {pct}",
    "zh-HK": "保本增量銷售額 {amount}，相當於比基線多賣 {pct}",
    en: "Break-even incremental sales {amount}, i.e. selling {pct} above baseline",
  },
  "promotion.breakeven.sacrifice": {
    "zh-CN": "其中 {amount} 是原有销量因为让利少赚的毛利",
    "zh-HK": "其中 {amount} 是原有銷量因為讓利少賺的毛利",
    en: "Of which {amount} is gross profit given away on sales you would have made anyway",
  },
  "promotion.breakeven.unachievable": {
    "zh-CN": "折后每多卖一元也不赚钱，所以不存在保本点，卖得越多亏得越多。要么降推广费，要么把折扣力度收回来。",
    "zh-HK": "折後每多賣一元也不賺錢，所以不存在保本點，賣得越多虧得越多。要麼降推廣費，要麼把折扣力度收回來。",
    en: "Every extra yuan sold still loses money after discount, so no break-even point exists — the more you sell, the more you lose. Cut the marketing spend or soften the discount.",
  },
  "promotion.breakeven.basis": {
    "zh-CN": "基线销售额和基线毛利率取活动前同期的实际经营事实，和投后复盘用的是同一套基线，两个数能对上。",
    "zh-HK": "基線銷售額和基線毛利率取活動前同期的實際經營事實，和投後覆盤用的是同一套基線，兩個數能對上。",
    en: "Baseline revenue and margin come from actual operating facts in the pre-promotion period — the same baseline as the post-campaign review, so the two figures reconcile.",
  },
  "promotion.breakeven.rate_label": { "zh-CN": "折后毛利率 %", "zh-HK": "折後毛利率 %", en: "Discounted margin %" },
  "promotion.breakeven.cost_label": { "zh-CN": "固定投入", "zh-HK": "固定投入", en: "Fixed spend" },
  "promotion.breakeven.run": { "zh-CN": "算保本点", "zh-HK": "算保本點", en: "Compute breakeven" },
  "promotion.breakeven.missing_input": { "zh-CN": "请先填折后毛利率与固定投入", "zh-HK": "請先填折後毛利率與固定投入", en: "Fill in the discounted margin and fixed spend first" },
  "promotion.breakeven.uplift_na": { "zh-CN": "基线为零，无增幅可言", "zh-HK": "基線為零，無增幅可言", en: "no baseline to compare against" },
  "promotion.breakeven.failed": { "zh-CN": "保本测算失败，请重试", "zh-HK": "保本測算失敗，請重試", en: "Breakeven calculation failed, please retry" },
  // 报告版 ROI 假设测算（POST /reports/store-promotion-roi）：全局假设输入，
  // 不挂具体活动；活动级投后归因走 evaluateROI，投前保本走 BreakevenPanel。
  "promotion.roi_report.title": { "zh-CN": "促销 ROI 假设测算（报告版）", "zh-HK": "促銷 ROI 假設測算（報告版）", en: "Promotion ROI what-if (report version)" },
  "promotion.roi_report.desc": {
    "zh-CN": "直接给假设数字算一笔促销的增量账：增量毛利扣掉增量营业租金与投入成本。活动级的实际 ROI 复盘在活动详情里，这里是投前/跨活动的情景口径。",
    "zh-HK": "直接給假設數字算一筆促銷的增量賬：增量毛利扣掉增量營業租金與投入成本。活動級的實際 ROI 覆盤在活動詳情裡，這裡是投前/跨活動的情景口徑。",
    en: "Runs the incremental math on assumed figures: incremental gross profit minus incremental turnover rent and promotion cost. Campaign-level actuals live in each promotion's detail; this is the pre-launch, cross-campaign scenario view.",
  },
  "promotion.roi_report.baseline_sales": { "zh-CN": "基线销售额", "zh-HK": "基線銷售額", en: "Baseline sales" },
  "promotion.roi_report.promoted_sales": { "zh-CN": "促销期销售额", "zh-HK": "促銷期銷售額", en: "Promoted sales" },
  "promotion.roi_report.gross_margin_pct": { "zh-CN": "毛利率 %", "zh-HK": "毛利率 %", en: "Gross margin %" },
  "promotion.roi_report.promotion_cost": { "zh-CN": "促销投入", "zh-HK": "促銷投入", en: "Promotion cost" },
  "promotion.roi_report.turnover_rent_pct": { "zh-CN": "营业租金 %", "zh-HK": "營業租金 %", en: "Turnover rent %" },
  "promotion.roi_report.run": { "zh-CN": "测算", "zh-HK": "測算", en: "Evaluate" },
  "promotion.roi_report.missing_input": { "zh-CN": "请先填齐全部假设数字", "zh-HK": "請先填齊全部假設數字", en: "Fill in every assumption first" },
  "promotion.roi_report.failed": { "zh-CN": "ROI 测算失败，请重试", "zh-HK": "ROI 測算失敗，請重試", en: "ROI evaluation failed, please retry" },
  "promotion.roi_report.incremental_sales": { "zh-CN": "增量销售额", "zh-HK": "增量銷售額", en: "Incremental sales" },
  "promotion.roi_report.incremental_gross_profit": { "zh-CN": "增量毛利", "zh-HK": "增量毛利", en: "Incremental gross profit" },
  "promotion.roi_report.incremental_turnover_rent": { "zh-CN": "增量营业租金", "zh-HK": "增量營業租金", en: "Incremental turnover rent" },
  "promotion.roi_report.net_benefit": { "zh-CN": "净收益", "zh-HK": "淨收益", en: "Net benefit" },
  "promotion.roi_report.roi_note": { "zh-CN": "净收益 ÷ 促销投入；投入为零时不可得", "zh-HK": "淨收益 ÷ 促銷投入；投入為零時不可得", en: "Net benefit ÷ promotion cost; n/a when cost is zero" },
  "promotion.roi_report.basis": {
    "zh-CN": "情景口径（Scenario）· 结果带待复核标识，不构成经营结论",
    "zh-HK": "情景口徑（Scenario）· 結果帶待覆核標識，不構成經營結論",
    en: "Scenario basis · results are flagged for review and are not an operating conclusion",
  },
  // R2-3：利润差异归因。五条为工单定稿，不改写。
  "store360.attribution.title": { "zh-CN": "利润差异归因", "zh-HK": "利潤差異歸因", en: "Profit variance attribution" },
  "store360.attribution.order": {
    "zh-CN": "按「客流 → 转化率 → 客单价 → 毛利率 → 人工 → 经营占用 → 其他可控」的顺序逐项替换算出来的。换个顺序数字会变，所以这个顺序写在这儿，别人复核时能对上。",
    "zh-HK": "按「客流 → 轉化率 → 客單價 → 毛利率 → 人工 → 經營佔用 → 其他可控」的順序逐項替換算出來的。換個順序數字會變，所以這個順序寫在這兒，別人複核時能對上。",
    en: "Computed by sequential substitution in the order: footfall → conversion → average ticket → gross margin → labor → occupancy → other controllable. A different order gives different numbers, which is why the order is stated here — anyone reviewing can reproduce it.",
  },
  "store360.attribution.residual": {
    "zh-CN": "残差 {amount}。这部分是各因子交叉作用产生的，没有摊到任何一项里。残差占总差异超过 {threshold} 时说明这个解释不够完整，下面会标出来。",
    "zh-HK": "殘差 {amount}。這部分是各因子交叉作用產生的，沒有攤到任何一項裡。殘差占總差異超過 {threshold} 時說明這個解釋不夠完整，下面會標出來。",
    en: "Residual {amount}. This part comes from interactions between factors and is not allocated to any single one. When the residual exceeds {threshold} of the total variance the explanation is incomplete, and a warning is shown below.",
  },
  "store360.attribution.material_warning": {
    "zh-CN": "残差占比偏高，这套分解解释不了大部分差异。建议先查一下基期和当期的口径是不是一致。",
    "zh-HK": "殘差占比偏高，這套分解解釋不了大部分差異。建議先查一下基期和當期的口徑是不是一致。",
    en: "The residual share is high — this decomposition does not explain most of the change. Check first whether the base and current periods use consistent definitions.",
  },
  "store360.attribution.unavailable": {
    "zh-CN": "少了 {fields}，整个归因算不了。不做部分归因：七项里少两项，剩下五项的贡献值是错的，不是不完整。",
    "zh-HK": "少了 {fields}，整個歸因算不了。不做部分歸因：七項裡少兩項，剩下五項的貢獻值是錯的，不是不完整。",
    en: "Missing {fields} — the whole attribution is unavailable. Partial attribution is not attempted: with two of seven inputs missing, the remaining five contributions would be wrong, not merely incomplete.",
  },
  "store360.attribution.base": { "zh-CN": "基期利润", "zh-HK": "基期利潤", en: "Base profit" },
  "store360.attribution.current": { "zh-CN": "当期利润", "zh-HK": "當期利潤", en: "Current profit" },
  "store360.attribution.f.footfall": { "zh-CN": "客流", "zh-HK": "客流", en: "Footfall" },
  "store360.attribution.f.conversion": { "zh-CN": "转化率", "zh-HK": "轉化率", en: "Conversion" },
  "store360.attribution.f.ticket": { "zh-CN": "客单价", "zh-HK": "客單價", en: "Avg ticket" },
  "store360.attribution.f.margin": { "zh-CN": "毛利率", "zh-HK": "毛利率", en: "Gross margin" },
  "store360.attribution.f.labor": { "zh-CN": "人工", "zh-HK": "人工", en: "Labor" },
  "store360.attribution.f.occupancy": { "zh-CN": "经营占用", "zh-HK": "經營佔用", en: "Occupancy" },
  "store360.attribution.f.other": { "zh-CN": "其他可控", "zh-HK": "其他可控", en: "Other controllable" },
  // R2-4：公式编辑器。err_* 为工单定稿。
  "finmodel.formula.editor_title": { "zh-CN": "公式编辑", "zh-HK": "公式編輯", en: "Formula editor" },
  "finmodel.formula.insert_hint": { "zh-CN": "点左边的科目行插入引用，或者直接输入科目键名。", "zh-HK": "點左邊的科目行插入引用，或者直接輸入科目鍵名。", en: "Click a row key to insert a reference, or type row keys directly." },
  "finmodel.formula.lag_hint": { "zh-CN": "要引用上一期的值用 lag(科目键, 1)。存货、应收、应付这类滚存科目要这么写。", "zh-HK": "要引用上一期的值用 lag(科目鍵, 1)。存貨、應收、應付這類滾存科目要這麼寫。", en: "Use lag(row key, 1) to reference the previous period. Rolling items like inventory and receivables need this." },
  "finmodel.formula.err_syntax": { "zh-CN": "第 {pos} 个字符这里写错了：{detail}", "zh-HK": "第 {pos} 個字符這裡寫錯了：{detail}", en: "Error near character {pos}: {detail}" },
  "finmodel.formula.err_unknown": { "zh-CN": "引用了不存在的科目「{key}」。检查一下是不是拼错了，或者这一行还没建。", "zh-HK": "引用了不存在的科目「{key}」。檢查一下是不是拼錯了，或者這一行還沒建。", en: "References unknown row \u300c{key}\u300d. Check the spelling, or create that row first." },
  "finmodel.formula.err_cycle": { "zh-CN": "循环引用：{path}。这几行互相引用对方的本期值，算不出来。用 lag() 引用上一期的值可以打破循环。", "zh-HK": "循環引用：{path}。這幾行互相引用對方的本期值，算不出來。用 lag() 引用上一期的值可以打破循環。", en: "Circular reference: {path}. These rows reference each other's same-period values. Use lag() on a previous period to break the cycle." },
  "finmodel.formula.validating": { "zh-CN": "正在校验", "zh-HK": "正在校驗", en: "Validating" },
  "finmodel.formula.valid": { "zh-CN": "公式没问题", "zh-HK": "公式沒問題", en: "Formula looks good" },
  "finmodel.formula.rows_hint": { "zh-CN": "这个公式会用到哪些科目键？逗号或空格分隔，填好后点下方键名插入引用。", "zh-HK": "這個公式會用到哪些科目鍵？逗號或空格分隔，填好後點下方鍵名插入引用。", en: "Which row keys does this formula use? Separate with commas or spaces, then click a key below to insert it." },
  // R2-2：新店业务可行性。五条为工单定稿。
  "predeal.feasibility.title": { "zh-CN": "新店能不能开：业务测算", "zh-HK": "新店能不能開：業務測算", en: "New store feasibility" },
  "predeal.feasibility.drivers": { "zh-CN": "销售额是按「商圈客流 × 进店率 × 转化率 × 客单价 × 营业天数」推出来的，不是直接填一个数。", "zh-HK": "銷售額是按「商圈客流 × 進店率 × 轉化率 × 客單價 × 營業天數」推出來的，不是直接填一個數。", en: "Sales are derived from area footfall \u00d7 entry rate \u00d7 conversion \u00d7 average ticket \u00d7 operating days — never typed in directly." },
  "predeal.feasibility.rampup": { "zh-CN": "爬坡期内按逐月系数打折。系数默认按同品牌新店的历史爬坡曲线，可以改。", "zh-HK": "爬坡期內按逐月係數打折。係數默認按同品牌新店的歷史爬坡曲線，可以改。", en: "Ramp months apply monthly factors. Defaults follow the historical ramp curve of comparable new stores and can be edited." },
  "predeal.feasibility.no_rate": {
    "zh-CN": "折现率还没确定，所以内部收益率、净现值、动态回本期这三项算不了。静态回本期和盈亏平衡销售额不受影响，已经算出来了。折现率定了以后重跑一次就有。",
    "zh-HK": "折現率還沒確定，所以內部收益率、淨現值、動態回本期這三項算不了。靜態回本期和盈虧平衡銷售額不受影響，已經算出來了。折現率定了以後重跑一次就有。",
    en: "No discount rate yet, so IRR, NPV and discounted payback cannot be computed. Static payback and break-even sales do not depend on it and are already calculated. Re-run once the rate is set.",
  },
  "predeal.feasibility.lease_source": { "zh-CN": "租金和使用权资产的数直接取自 IFRS 16 计量结果，这里不重算，所以和月结报表是同一个数。", "zh-HK": "租金和使用權資產的數直接取自 IFRS 16 計量結果，這裡不重算，所以和月結報表是同一個數。", en: "Rent and right-of-use figures come straight from the IFRS 16 measurement results and are not recomputed here — same numbers as the month-end reports." },
  "predeal.feasibility.label_footfall": { "zh-CN": "商圈日均客流", "zh-HK": "商圈日均客流", en: "Daily area footfall" },
  "predeal.feasibility.label_days": { "zh-CN": "营业天数/月", "zh-HK": "營業天數/月", en: "Operating days/mo" },
  "predeal.feasibility.label_entry": { "zh-CN": "进店率 %", "zh-HK": "進店率 %", en: "Entry rate %" },
  "predeal.feasibility.label_conversion": { "zh-CN": "转化率 %", "zh-HK": "轉化率 %", en: "Conversion %" },
  "predeal.feasibility.label_ticket": { "zh-CN": "客单价", "zh-HK": "客單價", en: "Avg ticket" },
  "predeal.feasibility.label_margin": { "zh-CN": "综合毛利率 %", "zh-HK": "綜合毛利率 %", en: "Gross margin %" },
  "predeal.feasibility.label_fitout": { "zh-CN": "装修设备投入", "zh-HK": "裝修設備投入", en: "Fitout & equipment" },
  "predeal.feasibility.label_inventory": { "zh-CN": "首批铺货", "zh-HK": "首批鋪貨", en: "Initial inventory" },
  "predeal.feasibility.label_ramp": { "zh-CN": "爬坡系数（逗号分隔，逐月）", "zh-HK": "爬坡係數（逗號分隔，逐月）", en: "Ramp factors (monthly, comma-separated)" },
  "predeal.feasibility.label_contract": { "zh-CN": "关联合同（可选，取其租赁计量数）", "zh-HK": "關聯合同（可選，取其租賃計量數）", en: "Related contract (optional; pulls its lease projection)" },
  "predeal.feasibility.label_discount": { "zh-CN": "折现率 %/月", "zh-HK": "折現率 %/月", en: "Discount rate %/mo" },
  "predeal.feasibility.run": { "zh-CN": "跑一次测算", "zh-HK": "跑一次測算", en: "Run feasibility" },
  "predeal.feasibility.metric_static": { "zh-CN": "静态回本期（月）", "zh-HK": "靜態回本期（月）", en: "Static payback (months)" },
  "predeal.feasibility.metric_dynamic": { "zh-CN": "动态回本期（月）", "zh-HK": "動態回本期（月）", en: "Discounted payback (months)" },
  "predeal.feasibility.metric_irr": { "zh-CN": "内部收益率（月）", "zh-HK": "內部收益率（月）", en: "IRR (monthly)" },
  "predeal.feasibility.metric_npv": { "zh-CN": "净现值", "zh-HK": "淨現值", en: "NPV" },
  "predeal.feasibility.metric_breakeven": { "zh-CN": "盈亏平衡销售额（月）", "zh-HK": "盈虧平衡銷售額（月）", en: "Break-even sales (monthly)" },
  ...
  "perf.kpi.equipment_facts": { "zh-CN": "设备事实数", "zh-HK": "設備事實數", en: "Equipment facts" },
  ...
  "perf.gov.equipment_unreconciled": { "zh-CN": "设备事实未对账", "zh-HK": "設備事實未對賬", en: "Equipment facts unreconciled" },
  ...
  "perf.col.utilization": { "zh-CN": "产能利用率", "zh-HK": "產能利用率", en: "Utilization" },
  ...
  "perf.tab.equipment": { "zh-CN": "设备事实对账", "zh-HK": "設備事實對賬", en: "Equipment fact reconciliation" },
  ...
  "perf.scenario.col_npv": { "zh-CN": "净现值", "zh-HK": "淨現值", en: "NPV" },
  ...
  "retail_import.step_prepare": { "zh-CN": "准备数据", "zh-HK": "準備數據", en: "Prepare data" },
  "retail_import.step_prepare_desc": { "zh-CN": "获取标准格式", "zh-HK": "取得標準格式", en: "Get the standard format" },
  "retail_import.step_upload": { "zh-CN": "上传与映射", "zh-HK": "上傳與映射", en: "Upload and map" },
  "retail_import.step_upload_desc": { "zh-CN": "校验字段", "zh-HK": "校驗字段", en: "Validate fields" },
  "retail_import.step_commit": { "zh-CN": "预审与入库", "zh-HK": "預審與入庫", en: "Review and commit" },
  "retail_import.step_commit_desc": { "zh-CN": "安全写入", "zh-HK": "安全寫入", en: "Safe write" },
  "retail_import.store_facts_title": { "zh-CN": "门店日粒度经营事实导入", "zh-HK": "門店日粒度經營事實導入", en: "Store-day operating facts" },
  "retail_import.dropzone_title": { "zh-CN": "点击或将门店经营事实文件拖拽至此处（.csv / .xlsx）", "zh-HK": "點擊或將門店經營事實文件拖放至此處（.csv / .xlsx）", en: "Click or drop a store operating facts file here (.csv / .xlsx)" },
  "retail_import.base_period": { "zh-CN": "覆盖期间", "zh-HK": "覆蓋期間", en: "Coverage period" },
  ...
  "tb_fill.title": { "zh-CN": "来自 AI 的列结构建议 · 待人工确认", "zh-HK": "來自 AI 的欄結構建議 · 待人工確認", en: "AI column-structure suggestion · pending confirmation" },
  "tb_fill.desc": {
    "zh-CN": "识别到 {rows} 行；列：{headers}；抽样科目：{samples}",
    "zh-HK": "識別到 {rows} 行；欄：{headers}；抽樣科目：{samples}",
    en: "Detected {rows} rows; columns: {headers}; sample accounts: {samples}",
  },
  ...
  "agent_metrics.status_measured": {
    "zh-CN": "已计量",
    "zh-HK": "已計量",
    en: "Measured",
  },
  "agent_metrics.status_calculated": {
    "zh-CN": "已计算",
    "zh-HK": "已計算",
    en: "Calculated",
  },
  "agent_metrics.status_unavailable": {
    "zh-CN": "不可用",
    "zh-HK": "不可用",
    en: "Unavailable",
  },
  ...
  "monthly.close_pack_title": { "zh-CN": "结账包导出（审计交接）", "zh-HK": "結賬包導出（審計交接）", en: "Close pack export (audit hand-off)" },
  "monthly.close_pack_export": { "zh-CN": "导出结账包 (.zip)", "zh-HK": "導出結賬包 (.zip)", en: "Export close pack (.zip)" },
  "monthly.close_pack_desc": {
    "zh-CN": "同一服务端披露投影的文件化快照：close_pack.json、disclosure.json 与 manifest.json 打包为 ZIP，附快照 ID 与政策版本。只读导出，不改变审批、过账或锁账状态。",
    "zh-HK": "同一服務端披露投影的文件化快照：close_pack.json、disclosure.json 與 manifest.json 打包為 ZIP，附快照 ID 與政策版本。只讀導出，不改變審批、過賬或鎖賬狀態。",
    en: "A file snapshot of the same server-side disclosure projection: close_pack.json, disclosure.json and manifest.json packaged as a ZIP with snapshot ID and policy version. Read-only export; it never changes approval, posting or lock state.",
  },
  "monthly.close_pack_need_period": { "zh-CN": "请先选择或生成月结期间", "zh-HK": "請先選擇或生成月結期間", en: "Select or generate a closing period first" },
  "monthly.close_pack_done": { "zh-CN": "结账包已导出", "zh-HK": "結賬包已導出", en: "Close pack exported" },
  "monthly.close_pack_failed": { "zh-CN": "结账包导出失败", "zh-HK": "結賬包導出失敗", en: "Close pack export failed" },
  ...
  "todo.exception_state_open": {
    "zh-CN": "待处理",
    "zh-HK": "待處理",
    en: "Open",
  },
  "todo.exception_state_investigating": {
    "zh-CN": "调查中",
    "zh-HK": "調查中",
    en: "Investigating",
  },
  "todo.exception_state_resolved": {
    "zh-CN": "已解决",
    "zh-HK": "已解決",
    en: "Resolved",
  },
  "todo.exception_state_waived": {
    "zh-CN": "已豁免",
    "zh-HK": "已豁免",
    en: "Waived",
  },
  "todo.exception_state_closed": {
    "zh-CN": "已关闭",
    "zh-HK": "已關閉",
    en: "Closed",
  },
  ...
  "contract_new.scope_section": {
    "zh-CN": "IFRS 16 范围判定",
    "zh-HK": "IFRS 16 範圍判定",
    en: "IFRS 16 Scope",
  },
  "contract_new.scope_gate": {
    "zh-CN": "范围闸门",
    "zh-HK": "範圍閘門",
    en: "Scope gate",
  },
  "contract_new.scope_gate_desc": {
    "zh-CN": "先判断合同是否需要资本化。短期租赁、低价值资产和非租赁合同不会生成 ROU 与租赁负债。",
    "zh-HK": "先判斷合同是否需要資本化。短期租賃、低價值資產和非租賃合同不會生成 ROU 與租賃負債。",
    en: "Decide whether the contract is capitalised first. Short-term leases, low-value assets and non-lease contracts do not create ROU or lease liabilities.",
  },
  "contract_new.scope_label": {
    "zh-CN": "计量范围",
    "zh-HK": "計量範圍",
    en: "Measurement scope",
  },
  "contract_new.scope_required": {
    "zh-CN": "请选择 IFRS 16 计量范围",
    "zh-HK": "請選擇 IFRS 16 計量範圍",
    en: "Select an IFRS 16 measurement scope",
  },
  "contract_new.scope_in_scope": {
    "zh-CN": "资本化租赁（ROU + 租赁负债）",
    "zh-HK": "資本化租賃（ROU + 租賃負債）",
    en: "Capitalised lease (ROU + lease liability)",
  },
  "contract_new.scope_short_term": {
    "zh-CN": "短期租赁豁免（直线法费用化）",
    "zh-HK": "短期租賃豁免（直線法費用化）",
    en: "Short-term lease exemption (straight-line expense)",
  },
  "contract_new.scope_low_value": {
    "zh-CN": "低价值资产豁免（直线法费用化）",
    "zh-HK": "低價值資產豁免（直線法費用化）",
    en: "Low-value asset exemption (straight-line expense)",
  },
  "contract_new.scope_not_lease": {
    "zh-CN": "非租赁合同（不入 IFRS 16）",
    "zh-HK": "非租賃合同（不入 IFRS 16）",
    en: "Non-lease contract (outside IFRS 16)",
  },
  "contract_new.exemption_reason": {
    "zh-CN": "豁免/排除依据",
    "zh-HK": "豁免/排除依據",
    en: "Exemption / exclusion basis",
  },
  "contract_new.exemption_reason_placeholder": {
    "zh-CN": "例如：租期 10 个月且无续租意图；未识别特定资产；低价值 IT 设备",
    "zh-HK": "例如：租期 10 個月且無續租意圖；未識別特定資產；低價值 IT 設備",
    en: "e.g. 10-month term with no renewal intent; no identified asset; low-value IT equipment",
  },
  ...
  "admin_users.role_readonly": {
    "zh-CN": "业务只读",
    "zh-HK": "業務只讀",
    en: "Business Readonly",
  },
  "admin_users.role_unknown": {
    "zh-CN": "角色不可用",
    "zh-HK": "角色不可用",
    en: "Role unavailable",
  },
  ...
  "search.action_forecast": { "zh-CN": "打开现金流测算", "zh-HK": "打開現金流測算", en: "Open cash-flow forecast" },
  ...
  "nav.portfolio": { "zh-CN": "租赁组合分析", "zh-HK": "租賃組合分析", en: "Lease portfolio" },
  // F3-2：导航标签与页面标题不一致时以页面标题为准
  // （pf.title=租赁组合分析；nav.cashflow↔cashflow.title；nav.promotions↔promotion.title）
  "nav.fpna_workbench": { "zh-CN": "FP&A 经营工作台", "zh-HK": "FP&A 經營工作台", en: "FP&A Workbench" },
  ...
  // F3-2：「分析与决策」按 CONTEXT.md 的领域边界拆为两组（零售经营域 / 租赁交易域）
  "nav.group_operating_analysis": { "zh-CN": "经营分析", "zh-HK": "經營分析", en: "Operating analytics" },
  "nav.group_lease_decision": { "zh-CN": "租赁决策", "zh-HK": "租賃決策", en: "Lease decisions" },
  ...
  // 报价对比（POST /deals/compare）：2–5 套假设条款折算到同一组数字。
  "pre_deal.compare.title": { "zh-CN": "报价对比", "zh-HK": "報價對比", en: "Offer comparison" },
  "pre_deal.compare.desc": {
    "zh-CN": "把桌面上两套以上条款折算成同一组数字再比：有效租金是会计口径（直线化），现值是现金口径（按折现率折到今天），两者可以不一致——免租期或前期投入会把现金推迟。报价是假设条款，不写入台账。",
    "zh-HK": "把桌面上兩套以上條款折算成同一組數字再比：有效租金是會計口徑（直線化），現值是現金口徑（按折現率折到今天），兩者可以不一致——免租期或前期投入會把現金推遲。報價是假設條款，不寫入台賬。",
    en: "Reduces two or more sets of terms to the same numbers before comparing: effective rent is the accounting view (straight-lined), present value is the cash view (discounted to today) — they can disagree, because rent-free periods and upfront spend defer cash. Offers are hypothetical terms; nothing is written to the ledger.",
  },
  "pre_deal.compare.offer_name": { "zh-CN": "方案名称", "zh-HK": "方案名稱", en: "Offer name" },
  "pre_deal.compare.other_monthly_cost": { "zh-CN": "其他月度成本", "zh-HK": "其他月度成本", en: "Other monthly cost" },
  "pre_deal.compare.landlord_contribution": { "zh-CN": "业主补贴", "zh-HK": "業主補貼", en: "Landlord contribution" },
  "pre_deal.compare.area_sqm": { "zh-CN": "面积（㎡）", "zh-HK": "面積（㎡）", en: "Area (sqm)" },
  "pre_deal.compare.add_offer": { "zh-CN": "添加方案", "zh-HK": "新增方案", en: "Add offer" },
  "pre_deal.compare.run": { "zh-CN": "对比报价", "zh-HK": "對比報價", en: "Compare offers" },
  "pre_deal.compare.failed": { "zh-CN": "报价对比失败，请检查条款后重试", "zh-HK": "報價對比失敗，請檢查條款後重試", en: "Comparison failed — check the terms and retry" },
  "pre_deal.compare.conclusion_title": { "zh-CN": "现值口径更省", "zh-HK": "現值口徑更省", en: "Cheapest on present value" },
  "pre_deal.compare.disagree": { "zh-CN": "两个口径结论不一致", "zh-HK": "兩個口徑結論不一致", en: "The two measures disagree" },
  "pre_deal.compare.col_total_rent": { "zh-CN": "总租金", "zh-HK": "總租金", en: "Total rent" },
  "pre_deal.compare.col_total_cost": { "zh-CN": "总成本", "zh-HK": "總成本", en: "Total cost" },
  "pre_deal.compare.col_effective": { "zh-CN": "有效月租金", "zh-HK": "有效月租金", en: "Effective monthly rent" },
  "pre_deal.compare.col_per_sqm": { "zh-CN": "有效租金/㎡/月", "zh-HK": "有效租金/㎡/月", en: "Effective rent /sqm/mo" },
  "pre_deal.compare.col_pv": { "zh-CN": "现值", "zh-HK": "現值", en: "Present value" },
  "pre_deal.compare.col_first_year": { "zh-CN": "首年租金", "zh-HK": "首年租金", en: "First-year rent" },
  "pre_deal.compare.note": {
    "zh-CN": "现值按年折现率 {rate}% 折算；未填面积时每平米列显示「—」。",
    "zh-HK": "現值按年折現率 {rate}% 折算；未填面積時每平米列顯示「—」。",
    en: "Present value discounts at an annual rate of {rate}%; the per-sqm column shows \"—\" when no area is given.",
  },
  ...
  "pre_deal.expense_curve_note": { "zh-CN": "利息在负债最大时最高，因此会计费用前高后低。两条线交叉之前的年份，实际入账费用高于按租金做的预算——本方案前 {years} 年如此，之后反向，全期相抵。", "zh-HK": "利息在負債最大時最高，因此會計費用前高後低。兩條線交叉之前的年份，實際入賬費用高於按租金做的預算——本方案前 {years} 年如此，之後反向，全期相抵。", en: "Interest peaks when the liability peaks, so accounting expense is front-loaded. Until the two lines cross, booked expense runs above the rent-based budget for {years} years on this plan, then the reverse, netting out over the term." },
  ...
  "fpna.version_promoted_official": { "zh-CN": "版本已发布为正式版本", "zh-HK": "版本已發布為正式版本", en: "Version published" },
  "fpna.col_name": { "zh-CN": "版本名称", "zh-HK": "版本名稱", en: "Version name" },
  "fpna.col_version": { "zh-CN": "版本", "zh-HK": "版本", en: "Version" },
  ...
  "fpna.btn_promote_official": { "zh-CN": "发布为正式版本", "zh-HK": "發布為正式版本", en: "Publish version" },
  ...
  "fpna.lineage_tree_title": { "zh-CN": "版本谱系", "zh-HK": "版本譜系", en: "Version lineage" },
  ...
  "fpna.form_prior_version": { "zh-CN": "前序版本", "zh-HK": "前序版本", en: "Prior version" },
  "fpna.card_governance_versions": { "zh-CN": "治理口径版本线", "zh-HK": "治理口徑版本線", en: "Governance Version Lines" },
  "fpna.modal_promote_official_title": { "zh-CN": "确认发布为正式版本", "zh-HK": "確認發布為正式版本", en: "Confirm publication" },
  "fpna.btn_confirm_promote": { "zh-CN": "确认发布", "zh-HK": "確認發布", en: "Confirm publication" },
  "fpna.warn_official_irreversible": { "zh-CN": "此操作不可逆：发布后该版本将冻结且不可篡改，并成为对外口径与审计基准。", "zh-HK": "此操作不可逆：發布後該版本將凍結且不可篡改，並成為對外口徑與審計基準。", en: "This action is irreversible: the version will be frozen and become the reporting and audit benchmark." },
  "standards.title": { "zh-CN": "多准则对比", "zh-HK": "多準則對比", en: "Standards comparison" },
  "standards.contract_required": { "zh-CN": "请选择合同", "zh-HK": "請選擇合同", en: "Select a contract" },
  "standards.select_approved": { "zh-CN": "选择已审批合同", "zh-HK": "選擇已審批合同", en: "Select an approved contract" },
  "standards.discount_rate": { "zh-CN": "折现率", "zh-HK": "折現率", en: "Discount rate" },
  "standards.rate_placeholder": { "zh-CN": "默认合同或系统利率", "zh-HK": "默認合同或系統利率", en: "Use contract or system rate" },
  "standards.generate": { "zh-CN": "生成对比", "zh-HK": "生成對比", en: "Run comparison" },
  "standards.generated": { "zh-CN": "多准则对比已生成", "zh-HK": "多準則對比已生成", en: "Comparison generated" },
  "standards.failed": { "zh-CN": "多准则对比失败", "zh-HK": "多準則對比失敗", en: "Comparison failed" },
  "standards.note_title": { "zh-CN": "管理层对比视图", "zh-HK": "管理層對比視圖", en: "Management comparison view" },
  "standards.note_desc": { "zh-CN": "本页用于展示不同准则的政策差异，不替代完整法定准则子账；IFRS 16 仍是受控计量基线。", "zh-HK": "本頁用於展示不同準則的政策差異，不替代完整法定準則子賬；IFRS 16 仍是受控計量基線。", en: "Use this view to compare policy differences; it does not replace a statutory subledger. IFRS 16 remains the controlled measurement baseline." },
  "standards.scope": { "zh-CN": "范围", "zh-HK": "範圍", en: "Scope" },
  "standards.currency": { "zh-CN": "币种", "zh-HK": "幣種", en: "Currency" },
  "standards.view_count": { "zh-CN": "准则视图数", "zh-HK": "準則視圖數", en: "Standard views" },
  "standards.initial_liability": { "zh-CN": "初始负债", "zh-HK": "初始負債", en: "Initial liability" },
  "standards.expense_delta": { "zh-CN": "首期费用差异", "zh-HK": "首期費用差異", en: "First-period expense difference" },
  "standards.chart_title": { "zh-CN": "初始确认与首期损益", "zh-HK": "初始確認與首期損益", en: "Initial recognition and first-period expense" },
  "standards.first_expense": { "zh-CN": "首期费用", "zh-HK": "首期費用", en: "First-period expense" },
  "standards.detail_title": { "zh-CN": "准则差异明细", "zh-HK": "準則差異明細", en: "Standards comparison detail" },
  "standards.standard": { "zh-CN": "准则", "zh-HK": "準則", en: "Standard" },
  "standards.classification": { "zh-CN": "分类", "zh-HK": "分類", en: "Classification" },
  "standards.measurement_path": { "zh-CN": "计量路径", "zh-HK": "計量路徑", en: "Measurement path" },
  "standards.rou_asset": { "zh-CN": "ROU 资产", "zh-HK": "ROU 資產", en: "ROU asset" },
  "standards.total_cost": { "zh-CN": "总确认成本", "zh-HK": "總確認成本", en: "Total recognised cost" },
  "standards.balance_sheet": { "zh-CN": "资产负债表", "zh-HK": "資產負債表", en: "Balance sheet" },
  "standards.pnl_pattern": { "zh-CN": "损益模式", "zh-HK": "損益模式", en: "P&L pattern" },
  "sensitivity.title": { "zh-CN": "敏感性分析", "zh-HK": "敏感性分析", en: "Sensitivity analysis" },
  "sensitivity.scope": { "zh-CN": "范围", "zh-HK": "範圍", en: "Scope" },
  "sensitivity.currency": { "zh-CN": "币种", "zh-HK": "幣種", en: "Currency" },
  "sensitivity.contract_required": { "zh-CN": "请选择合同", "zh-HK": "請選擇合同", en: "Select a contract" },
  "sensitivity.select_approved": { "zh-CN": "选择已审批合同", "zh-HK": "選擇已審批合同", en: "Select an approved contract" },
  "sensitivity.base_rate": { "zh-CN": "基准折现率", "zh-HK": "基準折現率", en: "Base discount rate" },
  "sensitivity.rate_placeholder": { "zh-CN": "默认合同或系统利率", "zh-HK": "默認合同或系統利率", en: "Use contract or system rate" },
  "sensitivity.shock": { "zh-CN": "冲击幅度", "zh-HK": "衝擊幅度", en: "Shock range" },
  "sensitivity.shock_required": { "zh-CN": "请填写冲击幅度", "zh-HK": "請填寫衝擊幅度", en: "Enter a shock range" },
  "sensitivity.generate": { "zh-CN": "生成分析", "zh-HK": "生成分析", en: "Run analysis" },
  "sensitivity.base_liability": { "zh-CN": "基准初始负债", "zh-HK": "基準初始負債", en: "Base initial liability" },
  "sensitivity.max_up": { "zh-CN": "最大上行影响", "zh-HK": "最大上行影響", en: "Largest upward impact" },
  "sensitivity.max_down": { "zh-CN": "最大下行影响", "zh-HK": "最大下行影響", en: "Largest downward impact" },
  "sensitivity.chart_title": { "zh-CN": "利率敏感性图", "zh-HK": "利率敏感性圖", en: "Interest-rate sensitivity" },
  "sensitivity.rate_shock": { "zh-CN": "利率冲击 ±{percent}%", "zh-HK": "利率衝擊 ±{percent}%", en: "Rate shock ±{percent}%" },
  "sensitivity.empty": { "zh-CN": "暂无敏感度数据", "zh-HK": "暫無敏感度數據", en: "No sensitivity data" },
  "sensitivity.low_scenario": { "zh-CN": "悲观/下调", "zh-HK": "悲觀/下調", en: "Downside" },
  "sensitivity.high_scenario": { "zh-CN": "乐观/上调", "zh-HK": "樂觀/上調", en: "Upside" },
  "sensitivity.low_impact": { "zh-CN": "悲观/下调冲击", "zh-HK": "悲觀/下調衝擊", en: "Downside impact" },
  "sensitivity.high_impact": { "zh-CN": "乐观/上调收益", "zh-HK": "樂觀/上調收益", en: "Upside impact" },
  "sensitivity.detail_title": { "zh-CN": "场景明细", "zh-HK": "情景明細", en: "Scenario detail" },
  "sensitivity.scenario": { "zh-CN": "场景", "zh-HK": "情景", en: "Scenario" },
  "sensitivity.rate": { "zh-CN": "折现率", "zh-HK": "折現率", en: "Discount rate" },
  "sensitivity.initial_liability": { "zh-CN": "初始负债", "zh-HK": "初始負債", en: "Initial liability" },
  "sensitivity.rou_asset": { "zh-CN": "ROU 资产", "zh-HK": "ROU 資產", en: "ROU asset" },
  "sensitivity.liability_delta": { "zh-CN": "负债变动", "zh-HK": "負債變動", en: "Liability change" },
  "sensitivity.delta_percent": { "zh-CN": "变动比例", "zh-HK": "變動比例", en: "Change" },
  "sensitivity.generated": { "zh-CN": "敏感性分析已生成", "zh-HK": "敏感性分析已生成", en: "Sensitivity analysis generated" },
  "sensitivity.failed": { "zh-CN": "敏感性分析失败", "zh-HK": "敏感性分析失敗", en: "Sensitivity analysis failed" },
  ...
  "fpna.label_left_version": { "zh-CN": "基准版本", "zh-HK": "基準版本", en: "Baseline version" },
  "fpna.label_right_version": { "zh-CN": "对比版本", "zh-HK": "對比版本", en: "Comparison version" },
  "fpna.label_period": { "zh-CN": "期间", "zh-HK": "期間", en: "Period" },
  "fpna.label_grain": { "zh-CN": "粒度", "zh-HK": "粒度", en: "Grain" },
  "fpna.basis_label": { "zh-CN": "口径", "zh-HK": "口徑", en: "Basis" },
  "fpna.coverage_label": { "zh-CN": "覆盖", "zh-HK": "覆蓋", en: "Coverage" },
  "fpna.coverage_complete": { "zh-CN": "完整", "zh-HK": "完整", en: "Complete" },
  "fpna.grain_group": { "zh-CN": "集团", "zh-HK": "集團", en: "Group" },
  "fpna.grain_segment": { "zh-CN": "业务线", "zh-HK": "業務線", en: "Segment" },
  "fpna.grain_brand": { "zh-CN": "品牌", "zh-HK": "品牌", en: "Brand" },
  "fpna.grain_region": { "zh-CN": "区域", "zh-HK": "區域", en: "Region" },
  "fpna.grain_store": { "zh-CN": "门店", "zh-HK": "門店", en: "Store" },
  "fpna.grain_plant": { "zh-CN": "工厂", "zh-HK": "工廠", en: "Plant" },
  "fpna.grain_line": { "zh-CN": "生产线", "zh-HK": "生產線", en: "Line" },
  "fpna.grain_equipment": { "zh-CN": "设备", "zh-HK": "設備", en: "Equipment" },
  "fpna.grain_asset_type": { "zh-CN": "资产类别", "zh-HK": "資產類別", en: "Asset type" },
  ...
  "fpna.dq_category_unmapped": { "zh-CN": "未映射", "zh-HK": "未映射", en: "Unmapped" },
  "fpna.dq_category_ambiguous_mapping": { "zh-CN": "映射不明确", "zh-HK": "映射不明確", en: "Ambiguous mapping" },
  "fpna.dq_category_missing": { "zh-CN": "数据缺失", "zh-HK": "數據缺失", en: "Missing data" },
  "fpna.dq_category_low_confidence": { "zh-CN": "低置信度", "zh-HK": "低置信度", en: "Low confidence" },
  "fpna.dq_category_reconciliation": { "zh-CN": "勾稽差异", "zh-HK": "勾稽差異", en: "Reconciliation" },
  "fpna.dq_category_duplicate": { "zh-CN": "重复数据", "zh-HK": "重複數據", en: "Duplicate data" },
  "fpna.dq_category_invalid": { "zh-CN": "无效数据", "zh-HK": "無效數據", en: "Invalid data" },
  "fpna.dq_severity_critical": { "zh-CN": "严重", "zh-HK": "嚴重", en: "Critical" },
  "fpna.dq_severity_high": { "zh-CN": "高", "zh-HK": "高", en: "High" },
  "fpna.dq_severity_medium": { "zh-CN": "中", "zh-HK": "中", en: "Medium" },
  "fpna.dq_severity_low": { "zh-CN": "低", "zh-HK": "低", en: "Low" },
  "fpna.dq_status_open": { "zh-CN": "待处理", "zh-HK": "待處理", en: "Open" },
  "fpna.dq_status_acknowledged": { "zh-CN": "已确认", "zh-HK": "已確認", en: "Acknowledged" },
  "fpna.dq_status_resolved": { "zh-CN": "已解决", "zh-HK": "已解決", en: "Resolved" },
  "fpna.dq_status_accepted": { "zh-CN": "已接受", "zh-HK": "已接受", en: "Accepted" },
  ...
  "fpna.version_type_budget": { "zh-CN": "年度预算", "zh-HK": "年度預算", en: "Annual budget" },
  "fpna.version_type_forecast": { "zh-CN": "滚动预测", "zh-HK": "滾動預測", en: "Rolling forecast" },
  "fpna.version_type_actual": { "zh-CN": "实际数", "zh-HK": "實際數", en: "Actuals" },
  "fpna.version_type_prior_year": { "zh-CN": "上年同期", "zh-HK": "上年同期", en: "Prior year" },
  "fpna.version_type_scenario": { "zh-CN": "情景计划", "zh-HK": "情景計劃", en: "Scenario plan" },
  "fpna.version_type_target": { "zh-CN": "战略目标", "zh-HK": "戰略目標", en: "Strategic target" },
  "fpna.scenario_baseline": { "zh-CN": "基准情景", "zh-HK": "基準情景", en: "Baseline" },
  "fpna.scenario_optimistic": { "zh-CN": "乐观情景", "zh-HK": "樂觀情景", en: "Optimistic" },
  "fpna.scenario_pessimistic": { "zh-CN": "悲观情景", "zh-HK": "悲觀情景", en: "Pessimistic" },
  "fpna.scenario_stress": { "zh-CN": "压力情景", "zh-HK": "壓力情景", en: "Stress" },
  "fpna.scenario_upside": { "zh-CN": "乐观情景", "zh-HK": "樂觀情景", en: "Upside" },
  "fpna.scenario_downside": { "zh-CN": "悲观情景", "zh-HK": "悲觀情景", en: "Downside" },
  "fpna.scenario_custom": { "zh-CN": "自定义情景", "zh-HK": "自定義情景", en: "Custom" },
  ...
  "fpna.desc_official_status": { "zh-CN": "官方发布状态", "zh-HK": "官方發布狀態", en: "Publication status" },
  "fpna.status_review": { "zh-CN": "待复核", "zh-HK": "待覆核", en: "In review" },
  "fpna.status_official": { "zh-CN": "已发布", "zh-HK": "已發布", en: "Published" },
  "fpna.status_retired": { "zh-CN": "已归档", "zh-HK": "已歸檔", en: "Archived" },
  "fpna.status_published": { "zh-CN": "已发布", "zh-HK": "已發布", en: "Published" },
  "fpna.status_working": { "zh-CN": "未发布", "zh-HK": "未發布", en: "Not published" },
  "fpna.status_active": { "zh-CN": "启用", "zh-HK": "啟用", en: "Active" },
  "fpna.status_inactive": { "zh-CN": "停用", "zh-HK": "停用", en: "Inactive" },
  "fpna.as_of_short": { "zh-CN": "截至", "zh-HK": "截至", en: "as of" },
  ...
  "cashflow.scenario.load_failed": { "zh-CN": "情景测算失败", "zh-HK": "情景測算失敗", en: "Scenario simulation failed" },
  "cashflow.scenario.baseline_name": { "zh-CN": "基准（不做假设）", "zh-HK": "基準（不作假設）", en: "Baseline (no assumptions)" },
  "cashflow.scenario.assumption_name": { "zh-CN": "{renewal}% 续租、{closure}% 关店", "zh-HK": "{renewal}% 續租、{closure}% 關店", en: "{renewal}% renewals, {closure}% closures" },
  ...
  "machine_cred.client_secret": { "zh-CN": "Client Secret", "zh-HK": "Client Secret", en: "Client Secret" },
  ...
  "promotion.msg_load_failed": { "zh-CN": "促销活动加载失败", "zh-HK": "促銷活動載入失敗", en: "Failed to load promotions" },
  "promotion.msg_roi_failed": { "zh-CN": "活动复盘测算失败", "zh-HK": "活動復盤測算失敗", en: "Failed to evaluate promotion" },
  ...
  "promotion.placeholder_code": { "zh-CN": "例如：PROMO_2026_MEMBER_06", "zh-HK": "例如：PROMO_2026_MEMBER_06", en: "e.g. PROMO_2026_MEMBER_06" },
  "promotion.placeholder_name": { "zh-CN": "例如：6月夏日会员日", "zh-HK": "例如：6月夏日會員日", en: "e.g. June summer member day" },
  "promotion.type_discount": { "zh-CN": "商品直折", "zh-HK": "商品直折", en: "Direct discount" },
  "promotion.type_coupon": { "zh-CN": "满减满折", "zh-HK": "滿減滿折", en: "Threshold coupon" },
  "promotion.type_gift": { "zh-CN": "买赠 / 随单礼", "zh-HK": "買贈 / 隨單禮", en: "Gift with purchase" },
  "promotion.type_member_day": { "zh-CN": "会员日专享", "zh-HK": "會員日專享", en: "Member day" },
  "promotion.type_other": { "zh-CN": "其他营销", "zh-HK": "其他營銷", en: "Other marketing" },
  "promotion.type_unknown": { "zh-CN": "类型不可用", "zh-HK": "類型不可用", en: "Type unavailable" },
  "promotion.modal_add_cost_title": { "zh-CN": "录入实际活动费用", "zh-HK": "錄入實際活動費用", en: "Record Actual Promotion Cost" },
  "promotion.cost_type_subsidy": { "zh-CN": "商品毛利让利补贴", "zh-HK": "商品毛利讓利補貼", en: "Gross margin subsidy" },
  "promotion.cost_type_materials": { "zh-CN": "物料制作与布置", "zh-HK": "物料製作與佈置", en: "Materials and staging" },
  "promotion.cost_type_labor": { "zh-CN": "活动专岗与兼职人力", "zh-HK": "活動專崗與兼職人力", en: "Special and part-time labour" },
  "promotion.cost_type_marketing": { "zh-CN": "商圈与线上推广费", "zh-HK": "商圈與線上推廣費", en: "Mall and online marketing" },
  "promotion.cost_type_other": { "zh-CN": "其他杂费", "zh-HK": "其他雜費", en: "Other miscellaneous" },
  "promotion.cost_type_unknown": { "zh-CN": "费用类别不可用", "zh-HK": "費用類別不可用", en: "Cost category unavailable" },
  "promotion.scope_all": { "zh-CN": "全部适用范围", "zh-HK": "全部適用範圍", en: "All eligible scope" },
  "promotion.scope_unknown": { "zh-CN": "适用范围不可用", "zh-HK": "適用範圍不可用", en: "Scope unavailable" },
  ...
  "renewal.scenario_unknown": {
    "zh-CN": "情景不可用", "zh-HK": "情景不可用", en: "Scenario unavailable",
  },
  "renewal.assumption_unknown": {
    "zh-CN": "来源不可用", "zh-HK": "來源不可用", en: "Source unavailable",
  },
  "renewal.health_revenue": {
    "zh-CN": "{store} · {period} 营收 {value}", "zh-HK": "{store} · {period} 營收 {value}", en: "{store} · {period} revenue {value}",
  },
  "renewal.health_rent_to_sales": {
    "zh-CN": "租售比 {value}%", "zh-HK": "租售比 {value}%", en: "Rent-to-sales {value}%",
  },
  "renewal.health_gross_profit": {
    "zh-CN": "毛利 {value}", "zh-HK": "毛利 {value}", en: "Gross profit {value}",
  },
  "renewal.health_sales_per_sqm": {
    "zh-CN": "坪效 {value}", "zh-HK": "坪效 {value}", en: "Sales per sqm {value}",
  },
  "portfolio.rent_to_sales_load_failed": {
    "zh-CN": "租售比加载失败", "zh-HK": "租售比載入失敗", en: "Failed to load rent-to-sales data",
  },
  "portfolio.rent_to_sales_note": {
    "zh-CN": "租售比 = 当期应付固定租金 ÷ 当期营收。分母使用提成租金所依据的营收，因此提成租金本身不计入分子。",
    "zh-HK": "租售比 = 當期應付固定租金 ÷ 當期營收。分母使用提成租金所依據的營收，因此提成租金本身不計入分子。",
    en: "Rent-to-sales = fixed rent payable for the period ÷ period revenue. The denominator is the revenue used for turnover rent, so turnover rent is not added to the numerator.",
  },
  "portfolio.rent_to_sales_ratio": {
    "zh-CN": "组合租售比", "zh-HK": "組合租售比", en: "Portfolio rent-to-sales",
  },
  "portfolio.rent_to_sales_over_line": {
    "zh-CN": "超预警线门店", "zh-HK": "超預警線門店", en: "Stores above warning line",
  },
  "portfolio.rent_to_sales_no_revenue": {
    "zh-CN": "缺营收门店", "zh-HK": "缺營收門店", en: "Stores without revenue",
  },
  "portfolio.rent_to_sales_unavailable": {
    "zh-CN": "覆盖不足，暂不出值", "zh-HK": "覆蓋不足，暫不出值", en: "Insufficient coverage; no value",
  },
  "portfolio.rent_to_sales_status": {
    "zh-CN": "状态", "zh-HK": "狀態", en: "Status",
  },
  "portfolio.rent_to_sales_current_rent": {
    "zh-CN": "当期租金", "zh-HK": "當期租金", en: "Current rent",
  },
  "portfolio.rent_to_sales_current_revenue": {
    "zh-CN": "当期营收", "zh-HK": "當期營收", en: "Current revenue",
  },
  "admin.title": {
    "zh-CN": "管理后台", "zh-HK": "管理後台", en: "Admin console",
  },
  "admin.users": {
    "zh-CN": "用户管理", "zh-HK": "用戶管理", en: "Users",
  },
  "admin.profile": {
    "zh-CN": "个人资料", "zh-HK": "個人資料", en: "Profile",
  },
  "admin.logout": {
    "zh-CN": "退出登录", "zh-HK": "登出", en: "Sign out",
  },
  "admin.badge": {
    "zh-CN": "管理员", "zh-HK": "管理員", en: "ADMIN",
  },
  "enterprise.saved_views": {
    "zh-CN": "已保存视图:", "zh-HK": "已保存檢視:", en: "Saved views:",
  },
  "enterprise.quick_filter": {
    "zh-CN": "快速过滤…", "zh-HK": "快速篩選…", en: "Quick filter…",
  },
  "enterprise.no_data": {
    "zh-CN": "暂无数据", "zh-HK": "暫無資料", en: "No data",
  },
  "enterprise.advanced_filters": {
    "zh-CN": "高级筛选", "zh-HK": "進階篩選", en: "Advanced filters",
  },
  "enterprise.selected_count": {
    "zh-CN": "已选中 {count} 项", "zh-HK": "已選取 {count} 項", en: "{count} selected",
  },
  "enterprise.clear_selection": {
    "zh-CN": "取消选择", "zh-HK": "取消選擇", en: "Clear selection",
  },
  "enterprise.filter_title": {
    "zh-CN": "高级筛选", "zh-HK": "進階篩選", en: "Advanced filters",
  },
  "enterprise.clear_conditions": {
    "zh-CN": "清空条件", "zh-HK": "清空條件", en: "Clear conditions",
  },
  "enterprise.filter_hint": {
    "zh-CN": "组合多个过滤条件，筛选结果实时在背景表格中更新。", "zh-HK": "組合多個篩選條件，結果會即時在背景表格中更新。", en: "Combine filters; results update in the table as you edit them.",
  },
  "enterprise.filter_equals": {
    "zh-CN": "等于", "zh-HK": "等於", en: "Equals",
  },
  "enterprise.filter_not_equals": {
    "zh-CN": "不等于", "zh-HK": "不等於", en: "Does not equal",
  },
  "enterprise.filter_contains": {
    "zh-CN": "包含", "zh-HK": "包含", en: "Contains",
  },
  "enterprise.filter_greater_than": {
    "zh-CN": "大于", "zh-HK": "大於", en: "Greater than",
  },
  "enterprise.filter_less_than": {
    "zh-CN": "小于", "zh-HK": "小於", en: "Less than",
  },
  "enterprise.filter_value": {
    "zh-CN": "值", "zh-HK": "值", en: "Value",
  },
  "enterprise.add_condition": {
    "zh-CN": "增加条件", "zh-HK": "增加條件", en: "Add condition",
  },
  "enterprise.save_common_view": {
    "zh-CN": "存为常用视图", "zh-HK": "儲存為常用檢視", en: "Save as saved view",
  },
  "enterprise.view_name_placeholder": {
    "zh-CN": "例如：大额待复核合同", "zh-HK": "例如：大額待覆核合約", en: "For example: large contracts to review",
  },
  "enterprise.save": {
    "zh-CN": "保存", "zh-HK": "儲存", en: "Save",
  },
  "enterprise.syncing": {
    "zh-CN": "同步中…", "zh-HK": "同步中…", en: "Syncing…",
  },
  "enterprise.edit_hint": {
    "zh-CN": "点击可直接行内修改", "zh-HK": "點擊可直接行內修改", en: "Click to edit inline",
  },
};
