...
export const dict: TranslationDict = {
  ...
  "ecom.settlement.gate_allow": { "zh-CN": "门禁通过", "zh-HK": "門禁通過", en: "Gate allow" },
  "ecom.settlement.gate_deny": { "zh-CN": "门禁拒绝（未对平）", "zh-HK": "門禁拒絕（未對平）", en: "Gate deny" },
  ...
  "ecom.settlement.action_prepare": { "zh-CN": "Prepare", "zh-HK": "Prepare", en: "Prepare" },
  ...
  "ecom.settlement.status_changed": { "zh-CN": "状态 →", "zh-HK": "狀態 →", en: "Status →" },
  ...
  "plan.title": { "zh-CN": "Actual vs Budget 日常分析", "zh-HK": "Actual vs Budget 日常分析", en: "Actual vs Budget" },
  ...
  "plan.budget_version_missing": { "zh-CN": "预算版本：—", "zh-HK": "預算版本：—", en: "Budget version: —" },
